...
TC_API tc_csharp_inspect_descriptor* tc_csharp_inspect_descriptor_create(const char* type_name);
TC_API bool tc_csharp_inspect_descriptor_add_field(tc_csharp_inspect_descriptor* descriptor,
                                                   const char* path,
                                                   const char* label,
                                                   ...
                                                   double max,
                                                   double step);
TC_API bool tc_csharp_inspect_descriptor_attach(tc_csharp_inspect_descriptor* inspect_descriptor,
                                                tc_runtime_type_descriptor* runtime_descriptor);
TC_API void tc_csharp_inspect_descriptor_destroy(tc_csharp_inspect_descriptor* descriptor);
...
TC_API void tc_inspect_set_csharp_callbacks(tc_cs_inspect_get_fn getter, tc_cs_inspect_set_fn setter);
