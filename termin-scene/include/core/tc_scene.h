...
typedef enum tc_scene_structure_change_kind {
    ...
    TC_SCENE_STRUCTURE_COMPONENT_ORDER_CHANGED = 7
...
typedef enum tc_scene_component_filter_flags {
    TC_SCENE_FILTER_NONE = 0,
    TC_SCENE_FILTER_ENABLED = 1 << 0,
    TC_SCENE_FILTER_VISIBLE = 1 << 1,
    TC_SCENE_FILTER_ENTITY_ENABLED = 1 << 2,
    TC_SCENE_FILTER_ACTIVE_IN_EDITOR = 1 << 3
} tc_scene_component_filter_flags;
