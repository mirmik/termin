...
TC_POOL_API tc_archetype* tc_archetype_create(uint64_t type_mask,
...
TC_POOL_API uint32_t tc_archetype_alloc_row(tc_archetype* arch, tc_entity_id entity, const tc_soa_type_registry* reg);
...
TC_POOL_API tc_entity_id tc_archetype_free_row(tc_archetype* arch, uint32_t row, const tc_soa_type_registry* reg);
...
TC_POOL_API tc_entity_id tc_archetype_detach_row(tc_archetype* arch, uint32_t row, const tc_soa_type_registry* reg);
...
// Returns NULL if type not present.
TC_POOL_API void* tc_archetype_get_element(const tc_archetype* arch,
                                           uint32_t row,
...
TC_POOL_API tc_soa_query tc_soa_query_init(tc_archetype** archetypes,
