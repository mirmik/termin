...
namespace termin {
    ...
    struct ENTITY_API UnknownUpgradeDecision {
        ...
        static UnknownUpgradeDecision custom(std::string target_type, const tc_value* target_data);
    };

    using UnknownUpgradeStrategy = std::function<UnknownUpgradeDecision(
        const UnknownComponent& unknown, const Entity& entity, const TcSceneRef& scene)>;
    ...
    ENTITY_API bool prepare_components_to_unknown(const std::vector<TcSceneRef>& scenes,
    ...
    private:
        ...
        friend ENTITY_API bool prepare_components_to_unknown(const std::vector<TcSceneRef>&,
                                                             const std::vector<std::string>&,
                                                             UnknownComponentDegradationPlan&,
                                                             std::string*,
                                                             const UnknownComponentPreparationHooks&);
        friend ENTITY_API bool prepare_registered_components_to_unknown(const std::vector<std::string>&,
                                                                        UnknownComponentDegradationPlan&,
                                                                        std::string*,
                                                                        const UnknownComponentPreparationHooks&);
    };
    ...
    ENTITY_API bool prepare_registered_components_to_unknown(const std::vector<std::string>& type_names,
                                                             UnknownComponentDegradationPlan& plan,
                                                             std::string* error = nullptr,
                                                             const UnknownComponentPreparationHooks& hooks = {});

    ENTITY_API bool
    degrade_component_ref_to_unknown(const Entity& entity, tc_component* component, std::string* error = nullptr);

    ENTITY_API bool
    upgrade_unknown_component_ref(const Entity& entity, tc_component* component, std::string* error = nullptr);

    ENTITY_API UnknownComponentStats degrade_components_to_unknown(const TcSceneRef& scene,
                                                                   const std::vector<std::string>& type_names);

    ENTITY_API UnknownComponentStats upgrade_unknown_components(const TcSceneRef& scene,
                                                                const std::vector<std::string>& type_names = {});
    ...
    ENTITY_API UnknownComponentStats
    upgrade_registered_unknown_components(const std::vector<std::string>& type_names = {});

    ENTITY_API UnknownComponentStats upgrade_registered_unknown_components(
        const UnknownUpgradeStrategy& strategy, const std::vector<std::string>& type_names = {});
