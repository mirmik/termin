...
namespace termin {
    ...
    public:
        ...
        explicit TcSceneRef(tc_scene_handle h)
            : _h(h) {}
        ...
        TcSceneRef(TcSceneRef&& other) noexcept
            : _h(other._h) {
        ...
        int load_from_data(const nos::trent& data,
        ...
        int load_from_data_unknown_only(const nos::trent& data,
                                        bool update_settings = true,
                                        const UnknownUpgradeStrategy& strategy = {},
