...
namespace termin {
    ...
    struct ENTITY_API GeneralTransform3 {
        ...
        GeneralTransform3(tc_entity_handle h)
            : _h(h) {}
        ...
        bool try_reparent_preserve_world(GeneralTransform3 new_parent, double tolerance = 1.0e-10);
        void unparent();
        ...
        bool try_inverse_world_affine(Affine3d& inverse, double epsilon = 1.0e-12) const;
        void inverse_world_matrix(double* m, double epsilon = 1.0e-12) const;
