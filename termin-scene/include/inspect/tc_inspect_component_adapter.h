...
TC_API bool tc_component_inspect_set_checked(tc_component* c, const char* path, tc_value value, void* context);
TC_API tc_inspect_apply_result tc_component_inspect_deserialize_checked(tc_component* c,
                                                                        const tc_value* data,
                                                                        void* context);
...
// size query.
TC_API size_t tc_component_get_field_string_buffer(tc_component* c, const char* path, char* buffer, size_t buffer_size);
