...
namespace termin {
    ...
    void register_builtin_scene_component_types() {
        auto component = ComponentTypeDescriptorBuilder::abstract_native("Component", "termin-scene");
        stage_component_base_inspect_fields(component.inspect());
        (void)component.commit();
        auto cxx = ComponentTypeDescriptorBuilder::abstract_native("CxxComponent", "termin-scene", "Component");
        (void)cxx.commit();
