...
`#1048`, `#1049`, `#1050`, `#1051` и `#1052` реализованы и находятся в
`On Test`; их blocker-связи с последующими этапами сняты. `#1053` и `#1054`
разблокированы и находятся в `Ready`. `#1055` сохраняет типизированные
зависимости от `#1053` и `#1054`.
