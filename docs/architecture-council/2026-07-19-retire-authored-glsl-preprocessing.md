...
- #674 — убрать неявные GLSL defaults и сделать authored/build/runtime
  contract Slang-only;
- #675 — удалить `GlslPreprocessor`, TGFX callback, `GlslAsset` и runtime
  lifecycle wiring;
- #640 — исправить ownership и сохранение shader contract в variants
  `LineRenderer`;
...
- `termin-graphics/include/tgfx/tgfx_shader_preprocess.h`;
- `termin-graphics/include/tgfx2/internal/shader_preprocess.hpp`;
