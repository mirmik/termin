...
- `termin-components/termin-components-render/python/termin/render_components/skybox_renderer.py`:
  skybox view matrix translation removal now uses `Mat44.with_translation(Vec3.zero())`;
  NumPy import removed.
- `termin-render-passes/python/termin/render_passes/highlight.py` and
  `termin-graphics/python/bindings/tgfx2_bindings.cpp`: highlight uniform packing now
