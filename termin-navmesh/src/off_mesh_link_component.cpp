...
namespace termin {
    ...
    void OffMeshLinkComponent::register_type() {
        ...
        tc::stage_inspect_field(
            descriptor.inspect(), &OffMeshLinkComponent::enabled, "OffMeshLinkComponent", "enabled", "Enabled", "bool");
        ...
        tc::stage_inspect_button_method<OffMeshLinkComponent>(
            descriptor.inspect(), "center_btn", "Center Entity", &OffMeshLinkComponent::center_entity);
