...
namespace termin {
    ...
    public:
        ...
        RecastBuildResult build(const float* verts, int nverts, const int* tris, int ntris);

        RecastBuildResult build_with_areas(
    ...
    private:
        ...
        RecastBuildResult build_internal(const float* verts,
                                         int nverts,
                                         const int* tris,
                                         int ntris,
