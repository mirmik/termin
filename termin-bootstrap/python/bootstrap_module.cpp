...
namespace {
    ...
    termin::bootstrap::SceneExtensionOptions
    scene_extension_options_from_kwargs(bool render_mount, bool render_state, bool collision_world) {
...
NB_MODULE(_bootstrap_native, m) {
    ...
    m.def("bootstrap_runtime", static_cast<void (*)()>(&termin::bootstrap::bootstrap_runtime));
