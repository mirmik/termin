...
namespace termin::physics_qopt
{
    ...
    public:
        ...
        [[nodiscard]] Multibody2DDiagnostic
        set_body_state(RigidBody2DHandle body, RigidBody2DState state) noexcept;
        [[nodiscard]] Multibody2DDiagnostic
        set_body_wrench(RigidBody2DHandle body,
                        RigidBody2DWrench wrench) noexcept;
        [[nodiscard]] RigidBody2DState
        body_state(RigidBody2DHandle body) const noexcept;
        [[nodiscard]] RigidBody2DAcceleration
        body_acceleration(RigidBody2DHandle body) const noexcept;
        [[nodiscard]] termin::Vec2
        joint_reaction(Joint2DHandle joint) const noexcept;

        [[nodiscard]] Multibody2DStepResult
        step(termin::Vec2 gravity_world,
        ...
        [[nodiscard]] double
        total_energy(termin::Vec2 gravity_world) const noexcept;
