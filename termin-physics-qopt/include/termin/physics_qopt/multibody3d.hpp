...
namespace termin::physics_qopt
{
    ...
    class TERMIN_PHYSICS_QOPT_API RigidBody3DContribution final
    ...
    public:
        ...
        [[nodiscard]] termin::Screw3
        velocity_at_body_origin_world() const noexcept;
        ...
        set_state(RigidBody3DState state) noexcept;
        [[nodiscard]] Multibody3DDiagnostic
    ...
    private:
        ...
        termin::Screw3 twist_rate_at_body_origin_local_ =
            termin::Screw3::zero();
    ...
    // blocks.
    class TERMIN_PHYSICS_QOPT_API ForceOnBody3DContribution final
        : public DynamicsContribution
    {
    public:
    ...
    class TERMIN_PHYSICS_QOPT_API FixedPointJoint3DContribution final
        : public DynamicsContribution
    {
    public:
    ...
    class TERMIN_PHYSICS_QOPT_API PointJoint3DContribution final
        : public DynamicsContribution
    {
    public:
    ...
    class TERMIN_PHYSICS_QOPT_API FixedRevoluteJoint3DContribution final
        : public DynamicsContribution
    {
    public:
    ...
    // unconstrained.
    class TERMIN_PHYSICS_QOPT_API RevoluteJoint3DContribution final
        : public DynamicsContribution
    {
    public:
