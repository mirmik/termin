...
namespace termin::physics_qopt
{
    ...
    class TERMIN_PHYSICS_QOPT_API ContactSet3DContribution final
        : public DynamicsContribution
    {
    public:
        explicit ContactSet3DContribution(
        ...
        [[nodiscard]] const std::vector<ContactState3D>&
        ...
        [[nodiscard]] bool
        set_maximum_cached_contacts(std::size_t maximum) noexcept;
