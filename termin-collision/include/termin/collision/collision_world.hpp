...
namespace termin
{
    namespace collision
    {
        ...
        private:
            void test_contact_pair(Collider* a,
                                   Collider* b,
            ...
            static std::array<Vec3, 4>
            get_face_vertices(const Vec3& center,
                              const std::array<Vec3, 3>& axes,
                              const Vec3& half_size,
                              int face_index);
            static Vec3 get_face_normal(const std::array<Vec3, 3>& axes,
                                        int face_index);
        ...
        public:
            ...
            RayHit raycast_closest(const Ray3& ray,
                                   const RaycastQuery& query) const;
            const BVH& bvh() const;
