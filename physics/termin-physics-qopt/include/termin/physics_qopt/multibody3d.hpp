...
namespace termin::physics_qopt {
    ...
    class TERMIN_PHYSICS_QOPT_API RigidBody3DContribution final : public DynamicsContribution {
    public:
        ...
        [[nodiscard]] const termin::Screw3& twist_rate_at_body_origin_local() const noexcept;
        ...
        [[nodiscard]] PointKinematics3DResult point_kinematics(termin::Vec3 point_local) const noexcept;
        [[nodiscard]] Multibody3DDiagnostic set_state(RigidBody3DState state) noexcept;
        [[nodiscard]] Multibody3DDiagnostic set_gravity_world(termin::Vec3 gravity) noexcept;
    ...
    // blocks.
    class TERMIN_PHYSICS_QOPT_API ForceOnBody3DContribution final : public DynamicsContribution {
    public:
        ...
        [[nodiscard]] const termin::Screw3& wrench_at_body_origin_world() const noexcept;
    ...
    class TERMIN_PHYSICS_QOPT_API FixedPointJoint3DContribution final : public DynamicsContribution {
    public:
        ...
        [[nodiscard]] const termin::Screw3& reaction_at_joint_anchor_world() const noexcept;
        AssemblyDiagnostic register_topology(DynamicsTopology& topology) noexcept override;
        AssemblyDiagnostic assemble(DynamicsAssembly& assembly, DynamicsAssemblyPhase phase) noexcept override;
        AssemblyDiagnostic begin_step() noexcept override;
        void commit_step() noexcept override;
    ...
    class TERMIN_PHYSICS_QOPT_API PointJoint3DContribution final : public DynamicsContribution {
    public:
    ...
    class TERMIN_PHYSICS_QOPT_API FixedRevoluteJoint3DContribution final : public DynamicsContribution {
    public:
    ...
    // unconstrained.
    class TERMIN_PHYSICS_QOPT_API RevoluteJoint3DContribution final : public DynamicsContribution {
    public:
