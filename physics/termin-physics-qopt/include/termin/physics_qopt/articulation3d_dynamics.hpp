...
namespace termin::physics_qopt {
    ...
    class TERMIN_PHYSICS_QOPT_API Articulation3DDynamicsContribution final : public DynamicsContribution {
    public:
        Articulation3DDynamicsContribution(robotics::Articulation3D& articulation,
        ...
        [[nodiscard]] robotics::Articulation3DDiagnostic diagnostic() const noexcept;
        [[nodiscard]] std::size_t unit_count() const noexcept;
        [[nodiscard]] std::size_t dof_count() const noexcept;
        [[nodiscard]] const std::vector<robotics::ArticulationUnit3D>& units() const noexcept;
        [[nodiscard]] const robotics::Articulation3DState& state() const noexcept;
        [[nodiscard]] bool has_floating_base() const noexcept;
        [[nodiscard]] const std::optional<robotics::ArticulationFloatingBase3D>& floating_base() const noexcept;
        ...
        [[nodiscard]] const std::vector<ArticulationUnitLimitState3D>& unit_limit_states() const noexcept;
        [[nodiscard]] DynamicsDofHandle dofs() const noexcept;
        [[nodiscard]] termin::Vec3 gravity_world() const noexcept;
        [[nodiscard]] ArticulationDynamicsAssemblyCounters assembly_counters() const noexcept;
        void reset_assembly_counters() noexcept;
        [[nodiscard]] PointKinematics3DResult point_kinematics(std::size_t unit_index,
                                                               termin::Vec3 point_local) const noexcept;
        [[nodiscard]] PointKinematics3DResult floating_base_point_kinematics(termin::Vec3 point_local) const noexcept;

        [[nodiscard]] robotics::Articulation3DDiagnostic set_state(robotics::Articulation3DState state) noexcept;
        [[nodiscard]] robotics::Articulation3DDiagnostic
        set_floating_base_state(termin::Pose3 pose_world, termin::Screw3 velocity_local) noexcept;
        [[nodiscard]] robotics::Articulation3DDiagnostic set_gravity_world(termin::Vec3 gravity) noexcept;
    ...
    private:
        ...
        robotics::Articulation3DDiagnostic diagnostic_ = robotics::Articulation3DDiagnostic::None;
        ...
        std::optional<robotics::ArticulationFloatingBase3D> floating_base_snapshot_;
