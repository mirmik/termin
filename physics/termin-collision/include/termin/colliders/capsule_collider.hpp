...
namespace termin {
    namespace colliders {
        ...
        public:
            ...
            from_total_height(double total_height, double radius, const GeneralPose3& t = GeneralPose3()) {
        ...
        private:
             ...
             */
            static void
            closest_points_segments(const Vec3& a1, const Vec3& b1, const Vec3& a2, const Vec3& b2, Vec3& p1, Vec3& p2);
            ...
            sphere_ray_hit(const Vec3& center, double r, const Vec3& origin, const Vec3& dir);
        };
        ...
        inline void CapsuleCollider::closest_points_segments(
            const Vec3& a1, const Vec3& b1, const Vec3& a2, const Vec3& b2, Vec3& p1, Vec3& p2) {
            Vec3 d1 = b1 - a1;
            Vec3 d2 = b2 - a2;
            Vec3 r = a1 - a2;
        ...
        CapsuleCollider::sphere_ray_hit(const Vec3& center, double r, const Vec3& origin, const Vec3& dir) {
        ...
        inline RayHit CapsuleCollider::closest_to_ray(const Ray3& ray) const {
            ...
            if (t_sphere_a)
                t_candidates.push_back(*t_sphere_a);

            auto t_sphere_b = sphere_ray_hit(B, R, O, D);
            if (t_sphere_b)
                t_candidates.push_back(*t_sphere_b);
