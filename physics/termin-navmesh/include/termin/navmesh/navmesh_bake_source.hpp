...
namespace termin {
    ...
    using NavMeshBakeVisitor = std::function<void(Entity, CxxComponent*, const NavMeshBakeContext&, NavMeshBakeInput&)>;
    ...
    TERMIN_NAVMESH_COMPONENTS_API NavMeshBakeInput collect_navmesh_bake_input(const NavMeshBakeContext& context,
                                                                              const std::vector<Entity>& entities);

    TERMIN_NAVMESH_COMPONENTS_API unsigned int stable_navmesh_source_user_id(Entity source,
                                                                             const std::string& local_id);

    TERMIN_NAVMESH_COMPONENTS_API unsigned char navmesh_detour_area_to_recast_area(int area_id);
    TERMIN_NAVMESH_COMPONENTS_API unsigned char navmesh_recast_area_to_detour_area(unsigned char recast_area,
