...
namespace termin {
    ...
    private:
        ...
        bool ensure_debug_mesh() const {
            ...
            if (same_vec3(_mesh_start, start_local) && same_vec3(_mesh_end, end_local) &&
        ...
        static void append_segment(std::vector<Vertex>& vertices,
                                   std::vector<uint32_t>& indices,
                                   const tc_vec3& a,
                                   const tc_vec3& b) {
        ...
        static void append_arrow(std::vector<Vertex>& vertices,
                                 std::vector<uint32_t>& indices,
                                 const tc_vec3& from,
                                 const tc_vec3& to) {
