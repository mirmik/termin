...
namespace termin {
    ...
    namespace {
        void register_navmesh_kind_handlers() {
            ...
            tc::KindRegistry::instance().register_python(
                ...
                nb::cpp_function([navmesh_type](nb::dict data) { return navmesh_type.attr("deserialize")(data); }));
    ...
    void bind_recast_navmesh_builder(nb::module_& m) {
        ...
        m.def(
            ...
            [](const std::string& owner) { NavMeshBakeVisitorRegistry::instance().set_registration_owner(owner); },
            nb::arg("owner"));
        ...
        m.def(
            ...
            [](const std::string& owner) { return NavMeshBakeVisitorRegistry::instance().unregister_owner(owner); },
            nb::arg("owner"));
        ...
        nb::class_<RecastBuildResult>(m, "RecastBuildResult")
            ...
            .def("has_poly_mesh", [](const RecastBuildResult& r) { return r.poly_mesh != nullptr; })
            .def("has_detail_mesh", [](const RecastBuildResult& r) { return r.detail_mesh != nullptr; })
            .def("poly_count", [](const RecastBuildResult& r) -> int { return r.poly_mesh ? r.poly_mesh->npolys : 0; })
            .def("vert_count", [](const RecastBuildResult& r) -> int { return r.poly_mesh ? r.poly_mesh->nverts : 0; });
        ...
        nb::class_<DetourNavMeshTileBuildResult>(m, "DetourNavMeshTileBuildResult")
            ...
            .def_prop_ro("data", [](const DetourNavMeshTileBuildResult& self) { return bytes_from_vector(self.data); });

        nb::class_<NavMeshKeeperComponent, CxxComponent>(m, "NavMeshKeeperComponent")
            .def("__init__", [](nb::handle self) { cxx_component_init<NavMeshKeeperComponent>(self); })
        ...
        nb::class_<OffMeshLinkComponent, CxxComponent>(m, "OffMeshLinkComponent")
            ...
            .def_prop_rw(
                "start_local",
                [](OffMeshLinkComponent& self) { return tc_vec3_to_vec3(self.start_local); },
                [](OffMeshLinkComponent& self, const Vec3& value) { self.start_local = tc_vec3_from_vec3(value); })
            .def_prop_rw(
                "end_local",
                [](OffMeshLinkComponent& self) { return tc_vec3_to_vec3(self.end_local); },
                [](OffMeshLinkComponent& self, const Vec3& value) { self.end_local = tc_vec3_from_vec3(value); })
            .def_rw("radius", &OffMeshLinkComponent::radius)
            .def_rw("bidirectional", &OffMeshLinkComponent::bidirectional)
            .def("start_world", [](OffMeshLinkComponent& self) { return self.start_world(); })
            .def("end_world", [](OffMeshLinkComponent& self) { return self.end_world(); })
        ...
        nb::class_<DetourClosestPointResult>(m, "DetourClosestPointResult")
            ...
            .def_prop_ro("point", [](const DetourClosestPointResult& self) { return point_to_python(self.point); });
        ...
        nb::class_<DetourRaycastResult>(m, "DetourRaycastResult")
            ...
            .def_prop_ro("hit_position",
                         [](const DetourRaycastResult& self) { return point_to_python(self.hit_position); })
            .def_prop_ro("hit_normal",
                         [](const DetourRaycastResult& self) { return point_to_python(self.hit_normal); });
        ...
        nb::class_<DetourQuerySession>(m, "DetourQuerySession")
            ...
            .def(
                "load_tile_data",
                [](DetourQuerySession& self, nb::handle data, const std::string& asset_name) {
            ...
            .def(
                "closest_point",
                [](DetourQuerySession& self, nb::handle point) { return self.closest_point(py_vec3(point)); },
                nb::arg("point"))
            .def(
                "closest_point_world",
                [](DetourQuerySession& self, const Pose3& bake_frame, nb::handle point) {
            ...
            .def(
                "find_path",
                [](DetourQuerySession& self, nb::handle start, nb::handle end) {
            ...
            .def(
                "find_path_world",
                [](DetourQuerySession& self, const Pose3& bake_frame, nb::handle start, nb::handle end) {
        ...
        nb::class_<DetourPathfindingWorldComponent, CxxComponent>(m, "DetourPathfindingWorldComponent")
            ...
            .def(
                "closest_point",
                [](DetourPathfindingWorldComponent& self, nb::handle point) {
                    return self.closest_point(py_vec3(point));
                },
                nb::arg("point"))
            .def(
                "closest_point_world",
                [](DetourPathfindingWorldComponent& self, const Pose3& bake_frame, nb::handle point) {
                    return self.closest_point_world(bake_frame, py_vec3(point));
                },
                nb::arg("bake_frame"),
                nb::arg("point"))
            .def(
                "find_path",
                [](DetourPathfindingWorldComponent& self, nb::handle start, nb::handle end) {
                    return path_to_python(self.find_path(py_vec3(start), py_vec3(end)));
                },
                nb::arg("start"),
                nb::arg("end"))
            .def(
                "find_path_world",
                [](DetourPathfindingWorldComponent& self, const Pose3& bake_frame, nb::handle start, nb::handle end) {
                    return path_to_python(self.find_path_world(bake_frame, py_vec3(start), py_vec3(end)));
                },
                nb::arg("bake_frame"),
                nb::arg("start"),
        ...
        nb::class_<PathfindingWorldCandidate>(m, "PathfindingWorldCandidate")
            ...
            .def_prop_ro("start_over_poly",
                         [](const PathfindingWorldCandidate& self) { return self.start_closest.over_poly; })
            .def_prop_ro("end_over_poly",
                         [](const PathfindingWorldCandidate& self) { return self.end_closest.over_poly; })
            .def_prop_ro(
                "start_closest_point",
                [](const PathfindingWorldCandidate& self) { return point_to_python(self.start_closest.point); })
            .def_prop_ro("end_closest_point",
                         [](const PathfindingWorldCandidate& self) { return point_to_python(self.end_closest.point); });
        ...
        nb::class_<PathfindingWorldPointCandidate>(m, "PathfindingWorldPointCandidate")
            ...
            .def_prop_ro("over_poly", [](const PathfindingWorldPointCandidate& self) { return self.closest.over_poly; })
        ...
        nb::class_<RecastNavMeshBuilderComponent, CxxComponent>(m, "RecastNavMeshBuilderComponent")
            .def("__init__", [](nb::handle self) { cxx_component_init<RecastNavMeshBuilderComponent>(self); })
            ...
            .def("apply_agent_type",
                 &RecastNavMeshBuilderComponent::apply_agent_type,
                 nb::arg("height"),
                 nb::arg("radius"),
                 nb::arg("max_climb"),
                 nb::arg("max_slope"),
            ...
            .def_prop_ro(
                "last_result",
                [](RecastNavMeshBuilderComponent& self) -> const RecastBuildResult& { return self.last_result; },
                nb::rv_policy::reference_internal)
            // Build method - accepts numpy arrays
            .def(
                "build",
                [](RecastNavMeshBuilderComponent& self,
            ...
            .def("build_detour_tile_data",
                 &RecastNavMeshBuilderComponent::build_detour_tile_data,
...
NB_MODULE(_navmesh_native, m) {
    ...
    m.def("register_navmesh_kind_handlers",
          &termin::register_navmesh_kind_handlers,
