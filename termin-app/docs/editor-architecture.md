...
Короткая карта того, что у редактора где лежит после MVC-рефакторинга. Для подробностей процесса см. [исторический план MVC-рефакторинга](../../docs/plans/2026-04-21-termin-app-editor-mvc-refactor.md).
