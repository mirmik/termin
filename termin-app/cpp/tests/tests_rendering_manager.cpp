...
TEST_CASE("RenderingManager attach_scene_full binds config viewports to scene") {
    ...
    rt_config.clear_linear_color = {0.02f, 0.03f, 0.07f, 1.0f};
    ...
    CHECK(std::fabs(clear_color.r - 0.02f) < 0.0001f);
    CHECK(std::fabs(clear_color.g - 0.03f) < 0.0001f);
    CHECK(std::fabs(clear_color.b - 0.07f) < 0.0001f);
    CHECK(std::fabs(clear_color.a - 1.0f) < 0.0001f);
