...
//
// Initializes Python and runs termin.launcher.app, which creates a native
// BackendWindow and renders the launcher UI.
...
int main(int argc, char* argv[]) {
    ...
    python_config.host_name = "termin_launcher";
