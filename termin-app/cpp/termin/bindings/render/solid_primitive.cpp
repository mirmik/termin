...
namespace termin {
    ...
    void bind_solid_primitive(nb::module_& m) {
        nb::class_<SolidPrimitiveRenderer>(m, "SolidPrimitiveRenderer")
            ...
            .def(
                "begin",
                [](SolidPrimitiveRenderer& self,
                   tgfx::RenderContext2* ctx2,
                   const Mat44f& view,
                   const Mat44f& proj,
                   bool depth_test,
                   bool blend) { self.begin(ctx2, view, proj, depth_test, blend); },
                nb::arg("ctx2"),
                nb::arg("view"),
                nb::arg("proj"),
            ...
            .def(
                ...
                [](SolidPrimitiveRenderer& self,
                   ...
                   const Mat44& proj,
                   bool depth_test,
                   bool blend) { self.begin(ctx2, mat44_to_mat44f(view), mat44_to_mat44f(proj), depth_test, blend); },
                nb::arg("ctx2"),
                nb::arg("view"),
                nb::arg("proj"),
                nb::arg("depth_test") = true,
            ...
            .def(
                ...
                nb::arg("length"),
                nb::arg("color"),
                nb::arg("shaft_radius") = 0.02f,
                nb::arg("head_radius") = 0.06f,
