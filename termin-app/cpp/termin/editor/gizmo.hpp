...
namespace termin {
    ...
    public:
        ...
        virtual void draw_solid(SolidPrimitiveRenderer* renderer,
        ...
        virtual void draw_transparent_solid(SolidPrimitiveRenderer* renderer,
                                            tgfx::RenderContext2* ctx2,
                                            const Mat44f& view,
                                            const Mat44f& proj) {}

        // Whether this gizmo uses SolidPrimitiveRenderer
        virtual bool uses_solid_renderer() const {
            return false;
        }
