...
namespace termin {
    ...
    public:
        ...
        void render(ImmediateRenderer* renderer,
    ...
    private:
        ...
        std::optional<Vec3f>
        _project_ray_to_constraint(const Vec3f& ray_origin, const Vec3f& ray_dir, const DragConstraint& constraint);
