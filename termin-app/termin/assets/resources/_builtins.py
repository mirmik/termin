...
BUILTIN_FRAME_PASSES: List[Tuple[str, str]] = [
    ...
    ("termin.visualization.render.framegraph.passes.depth", "DepthOnlyPass"),
    ("termin.visualization.render.framegraph.passes.depth", "DepthToColorPass"),
    ("termin.visualization.render.framegraph.passes.depth", "ColorToDepthPass"),
