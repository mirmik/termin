...
namespace termin::robotics
{
    ...
    velocity_control_diagnostic_name(
    ...
    struct TERMIN_ROBOTICS_API VelocityControlResult3D
    {
        ...
        VelocityControlDiagnostic3D diagnostic =
            VelocityControlDiagnostic3D::None;
    ...
    public:
        ...
        [[nodiscard]] VelocityControlResult3D
    ...
    [[nodiscard]] TERMIN_ROBOTICS_API std::string_view
    velocity_integration_diagnostic_name(
        VelocityIntegrationDiagnostic3D diagnostic) noexcept;

    struct TERMIN_ROBOTICS_API VelocityIntegrationResult3D
    {
        VelocityIntegrationDiagnostic3D diagnostic =
            VelocityIntegrationDiagnostic3D::None;
    ...
    [[nodiscard]] TERMIN_ROBOTICS_API VelocityIntegrationResult3D
