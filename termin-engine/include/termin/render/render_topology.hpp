...
namespace termin {
    ...
    public:
        ...
        const std::vector<tc_scene_handle>& attached_scenes() const {
            return attached_scenes_;
        }
        size_t attached_scene_count() const {
            return attached_scenes_.size();
        }
        ...
        tc_viewport_handle
        pipeline_target_viewport_at(tc_scene_handle scene, tc_pipeline_handle pipeline, size_t index) const;
        void set_pipeline_targets(tc_scene_handle scene,
                                  const std::string& pipeline_name,
                                  const std::vector<std::string>& targets);
        const std::vector<std::string>& get_pipeline_targets(tc_scene_handle scene,
        ...
        tc_render_target_handle find_render_target(tc_scene_handle scene, const std::string& name) const;
        ...
        size_t managed_render_target_count() const {
            return managed_render_targets_.size();
        }
        ...
        bool register_viewport(tc_scene_handle scene,
        ...
        size_t viewport_attachment_count() const {
            return viewport_attachments_.size();
        }
        const ViewportAttachment* viewport_attachment_at(size_t index) const;
        tc_viewport_handle find_viewport(tc_scene_handle scene, const std::string& name) const;
