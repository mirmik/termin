...
namespace termin {
    ...
    static tc_display_handle get_display_handle(nb::object display_py) {
        if (display_py.is_none())
            return TC_DISPLAY_HANDLE_INVALID;
        return tc_display_handle{nb::cast<uint32_t>(display_py.attr("index")),
    ...
    static std::tuple<uint32_t, uint32_t> render_target_handle_to_tuple(tc_render_target_handle h) {
        return {h.index, h.generation};
    }
    ...
    void bind_rendering_manager(nb::module_& m) {
        ...
        nb::class_<ViewportRenderState>(m, "ViewportRenderState")
            ...
            .def_prop_ro("output_color_tex", [](ViewportRenderState& self) { return self.output_color_tex; })
            .def_prop_ro("output_depth_tex", [](ViewportRenderState& self) { return self.output_depth_tex; });

        nb::class_<RenderAttachmentContext>(m, "RenderAttachmentContext")
            .def_static("_from_capsule",
                        [](nb::object capsule) {
                            void* pointer = PyCapsule_GetPointer(capsule.ptr(), "termin.RenderAttachmentContext");
                            if (!pointer)
                                throw nb::python_error();
                            return *reinterpret_cast<const RenderAttachmentContext*>(pointer);
                        })
            .def_prop_ro("valid", &RenderAttachmentContext::valid)
            .def_prop_ro("scene_handle", [](const RenderAttachmentContext& self) { return self.scene(); })
            .def_prop_ro("render_targets", &RenderAttachmentContext::render_targets)
            .def(
                "find_render_target",
                [](const RenderAttachmentContext& self, const std::string& name) -> nb::object {
            ...
            .def(
                "find_camera_target",
                [](const RenderAttachmentContext& self, nb::object camera) -> nb::object {
                    if (camera.is_none())
                        return nb::none();
                    uintptr_t pointer = nb::cast<uintptr_t>(camera.attr("c_ptr_int")());
                    tc_render_target_handle target =
                        self.find_camera_target(reinterpret_cast<const tc_component*>(pointer));
                    return tc_render_target_handle_valid(target) ? nb::cast(target) : nb::none();
                },
                nb::arg("camera"))
            .def(
        ...
        nb::class_<RenderTopology>(m, "RenderTopology")
            .def(
                "is_attached",
                [](const RenderTopology& self, nb::object scene_py) {
                    return self.is_attached(get_scene_handle(scene_py));
                },
                nb::arg("scene"))
            .def(
                "get_pipeline",
                [](const RenderTopology& self, nb::object scene_py, const std::string& name) -> nb::object {
            ...
            .def(
                "find_render_target",
                [](const RenderTopology& self, nb::object scene_py, const std::string& name) -> nb::object {
                    tc_render_target_handle target = self.find_render_target(get_scene_handle(scene_py), name);
            ...
            .def(
                ...
                nb::arg("scene"))
            .def_prop_ro("managed_render_targets",
                         [](const RenderTopology& self) { return self.managed_render_targets(); })
            .def(
                "viewports",
                [](const RenderTopology& self, nb::object scene_py) {
        ...
        nb::class_<RenderingManager>(m, "RenderingManager")
            .def_prop_ro(
                "topology",
                [](RenderingManager& self) -> RenderTopology& { return self.topology(); },
            ...
            .def_prop_ro("render_engine",
                         &RenderingManager::render_engine,
                         nb::rv_policy::reference,
                         "Access the engine's RenderEngine (tgfx2_ctx lives on it)")

            .def(
                "set_display_factory",
                [](RenderingManager& self, nb::object factory) {
                    if (factory.is_none()) {
            ...
            .def(
                "set_display_removed_callback",
                [](RenderingManager& self, nb::object callback) {
                    if (callback.is_none()) {
            ...
            .def(
                "try_auto_remove_display",
                [](RenderingManager& self, TcDisplay& display) -> bool {
            ...
            .def(
                "add_display",
                [](RenderingManager& self, TcDisplay& display, nb::object name_py) {
                    if (display.is_valid()) {
            ...
            .def(
                "remove_display",
                [](RenderingManager& self, TcDisplay& display) {
                    if (display.is_valid()) {
            ...
            .def(
                "register_viewport_attachment",
                [](RenderingManager& self, TcDisplay& display, nb::object viewport_py, bool destroy_on_scene_detach) {
                    return self.register_viewport_attachment(
                        display.handle(), get_viewport_handle(viewport_py), destroy_on_scene_detach);
                },
                nb::arg("display"),
                nb::arg("viewport"),
            ...
            .def(
                "unregister_viewport_attachment",
                [](RenderingManager& self, nb::object viewport_py) {
            ...
            .def_prop_ro(
                "editor_displays",
                [](RenderingManager& self) -> std::vector<TcDisplay> {
            ...
            .def(
                "get_display_by_name",
                [](RenderingManager& self, const std::string& name) -> nb::object {
                    tc_display_handle display = self.get_display_by_name(name);
                    return tc_display_alive(display) ? nb::cast(TcDisplay::from_handle(display)) : nb::none();
                },
                nb::arg("name"),
            ...
            .def_prop_ro(
                "display_count",
                [](RenderingManager& self) { return self.displays().size() + self.editor_displays().size(); },
            ...
            .def(
                "get_display_for_viewport",
                [](RenderingManager& self, nb::object viewport_py) -> nb::object {
            ...
            .def(
                "get_display_name",
                [](RenderingManager& self, TcDisplay& display) -> std::string { return display.name(); },
                nb::arg("display"),
                "Get display name")

            .def(
                "set_display_name",
                [](RenderingManager& self, TcDisplay& display, const std::string& name) { display.set_name(name); },
                nb::arg("display"),
                nb::arg("name"),
                "Set display name")
            ...
            .def(
                "attach_scene_full",
                [](RenderingManager& self, nb::object scene_py) -> std::vector<TcViewport> {
            ...
            .def(
                "detach_scene_full",
                [](RenderingManager& self, nb::object scene_py) {
                    tc_scene_handle scene = get_scene_handle(scene_py);
            ...
            .def(
                "unmount_scene",
                [](RenderingManager& self, nb::object scene_py, TcDisplay& display) {
                    tc_scene_handle scene = get_scene_handle(scene_py);
                    if (display.is_valid()) {
            ...
            .def(
                "register_managed_render_target",
                [](RenderingManager& self, nb::object rt_py) {
            ...
            .def(
                "unregister_managed_render_target",
                [](RenderingManager& self, nb::object rt_py) {
                    auto h = nb::cast<tc_render_target_handle>(rt_py);
            ...
            .def_prop_ro(
                ...
                [](RenderingManager& self) -> std::vector<tc_render_target_handle> {
            ...
            .def(
                "get_scene_pipeline",
                [](RenderingManager& self, nb::object scene_py, const std::string& name) -> nb::object {
                    tc_scene_handle scene = get_scene_handle(scene_py);
            ...
            .def("set_pipeline_targets",
                 &RenderingManager::set_pipeline_targets,
                 nb::arg("pipeline_name"),
                 nb::arg("targets"))

            .def("get_pipeline_targets",
                 &RenderingManager::get_pipeline_targets,
                 nb::arg("pipeline_name"),
                 nb::rv_policy::reference)
            ...
            .def("render_all",
                 &RenderingManager::render_all,
                 nb::arg("present") = true,
                 "Render all viewports (offscreen + present)")

            .def("render_all_offscreen",
                 &RenderingManager::render_all_offscreen,
                 "Phase 1: Render all viewports to their output FBOs")

            .def("present_all", &RenderingManager::present_all, "Phase 2: Blit viewport FBOs to displays")
            ...
            .def(
                "get_viewport_state",
                [](RenderingManager& self, nb::object viewport_py) -> ViewportRenderState* {
                    tc_viewport_handle vh = get_viewport_handle(viewport_py);
            ...
            .def("shutdown", &RenderingManager::shutdown, "Cleanup all resources")

            .def(
                "get_render_stats",
                [](RenderingManager& self) -> nb::dict {
                    nb::dict stats;
                    ...
                    stats["unmanaged_viewports"] =
                        count_unmanaged(self.displays()) + count_unmanaged(self.editor_displays());
                    ...
                    stats["pipeline_cache_create_pipeline_count"] = cache_stats.create_pipeline_count;
                    stats["pipeline_cache_cached_pipelines"] = cache_stats.cached_pipeline_count;
        ...
        nb::class_<RenderExecutionTargetId>(m, "RenderExecutionTargetId")
            .def_prop_ro("kind", [](const RenderExecutionTargetId& self) { return self.kind; })
            .def_prop_ro("viewport_handle",
                         [](const RenderExecutionTargetId& self) { return viewport_handle_to_tuple(self.viewport); })
            .def_prop_ro(
                "render_target_handle",
                [](const RenderExecutionTargetId& self) { return render_target_handle_to_tuple(self.render_target); })
            .def("__eq__", [](const RenderExecutionTargetId& self, const RenderExecutionTargetId& other) {
                return self == other;
            });

        nb::class_<RenderExecutionTargetInfo>(m, "RenderExecutionTargetInfo")
            .def_prop_ro("id", [](const RenderExecutionTargetInfo& self) { return self.id; })
            .def_prop_ro("display_handle",
                         [](const RenderExecutionTargetInfo& self) { return display_handle_to_tuple(self.display); })
            .def_prop_ro("scene_handle",
                         [](const RenderExecutionTargetInfo& self) { return scene_handle_to_tuple(self.scene); })
            .def_prop_ro("pipeline_handle",
                         [](const RenderExecutionTargetInfo& self) { return pipeline_handle_to_tuple(self.pipeline); })
            .def_prop_ro("pipeline",
                         [](const RenderExecutionTargetInfo& self) { return pipeline_to_python(self.pipeline); })
        ...
        nb::class_<FrameGraphDebuggerPassInfo>(m, "FrameGraphDebuggerPassInfo")
            ...
            .def_prop_ro("has_internal_symbols", &FrameGraphDebuggerPassInfo::has_internal_symbols)
            .def_prop_ro("display_name", &FrameGraphDebuggerPassInfo::display_name);

        nb::class_<FrameGraphDebugger>(m, "FrameGraphDebugger")
            .def(nb::init<RenderingManager&>(), nb::arg("rendering_manager"), nb::keep_alive<1, 2>())
            .def("refresh", &FrameGraphDebugger::refresh)
            .def("finish_frame", &FrameGraphDebugger::finish_frame)
            .def("select_target_at", &FrameGraphDebugger::select_target_at, nb::arg("index"))
            .def("clear_selection", &FrameGraphDebugger::clear_selection)
            .def("request_resource", &FrameGraphDebugger::request_resource, nb::arg("resource"))
            .def("request_internal", &FrameGraphDebugger::request_internal, nb::arg("pass_index"), nb::arg("symbol"))
            .def("set_paused", &FrameGraphDebugger::set_paused, nb::arg("paused"))
            ...
            .def_prop_ro("targets", [](const FrameGraphDebugger& self) { return self.targets(); })
            .def_prop_ro("selected_target_index", &FrameGraphDebugger::selected_target_index)
            ...
            .def_prop_rw(
                "selected_pass_index", &FrameGraphDebugger::selected_pass_index, &FrameGraphDebugger::set_selected_pass)
            .def_prop_ro("selected_pass", &FrameGraphDebugger::selected_pass_name)
            .def_prop_rw(
                "selected_symbol", &FrameGraphDebugger::selected_symbol, &FrameGraphDebugger::set_selected_symbol)
            .def_prop_rw(
                "selected_resource", &FrameGraphDebugger::selected_resource, &FrameGraphDebugger::set_selected_resource)
            .def_prop_rw("channel_mode", &FrameGraphDebugger::channel_mode, &FrameGraphDebugger::set_channel_mode)
            .def_prop_rw("highlight_hdr", &FrameGraphDebugger::highlight_hdr, &FrameGraphDebugger::set_highlight_hdr)
            ...
            .def("format_pass_json_at", &FrameGraphDebugger::format_pass_json_at, nb::arg("pass_index"))
            ...
            .def_prop_ro(
                "resolved_pipeline_handle",
                [](const FrameGraphDebugger& self) { return pipeline_handle_to_tuple(self.resolved_pipeline()); })
            .def_prop_ro("capture_tex", &FrameGraphDebugger::capture_tex)
            .def_prop_ro("depth_capture_tex", &FrameGraphDebugger::depth_capture_tex)
            .def_prop_ro(
                "capture",
                [](FrameGraphDebugger& self) -> FrameGraphCapture& { return self.capture(); },
                nb::rv_policy::reference_internal)
            .def_prop_ro(
                "depth_capture",
                [](FrameGraphDebugger& self) -> FrameGraphCapture& { return self.depth_capture(); },
                nb::rv_policy::reference_internal)
            .def_prop_ro(
                "presenter",
                [](FrameGraphDebugger& self) -> FrameGraphPresenter& { return self.presenter(); },
                nb::rv_policy::reference_internal);
    }
