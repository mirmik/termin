...
DEFAULT_DOMAIN_COMPONENT_SPECS: list[BuiltinTypeSpec] = [
    ...
    ("termin.physics_fem.fem_physics_world_component", "FEMPhysicsWorldComponent"),
    ("termin.physics_fem.fem_rigid_body_component", "FEMRigidBodyComponent"),
    ("termin.physics_fem.fem_fixed_joint_component", "FEMFixedJointComponent"),
    ("termin.physics_fem.fem_revolute_joint_component", "FEMRevoluteJointComponent"),
