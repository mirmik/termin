"""Default asset file pre-loader registration."""
...
class DefaultPreloaderResourceManager(Protocol):
    asset_type_plugins: object
    external_assets: object


def _create_plugin_preloader(
    resource_manager: DefaultPreloaderResourceManager,
    type_id: str,
...
__all__ = ["create_default_preloaders", "register_default_preloaders"]
