...
namespace {
    ...
    struct GraphEntry {
        explicit GraphEntry(std::shared_ptr<const ng::ConnectionValidator> validator = {})
            : graph(std::make_shared<ng::Graph>(std::move(validator))) {}
    ...
    template <typename T> tc_nodegraph_result finish(GraphEntry& entry, const ng::Result<T>& result) {
        if (result) {
...
namespace termin::nodegraph::detail {
    ...
    std::shared_ptr<Graph> acquire_c_graph(tc_nodegraph_handle handle) {
        std::lock_guard lock(graph_mutex);
        GraphEntry* entry = resolve(handle);
        if (entry == nullptr) {
            tc_log_error("NodeGraph C API: cannot acquire invalid graph handle");
            return {};
        }
        return entry->graph;
    }
...
size_t tc_nodegraph_copy_last_error(tc_nodegraph_handle graph, char* buffer, size_t capacity) {
    return access_graph(
        graph, size_t{0}, [&](GraphEntry& entry) { return copy_string(entry.last_error, buffer, capacity); });
}
...
size_t tc_nodegraph_copy_nodes(tc_nodegraph_handle graph, tc_nodegraph_node_handle* out_handles, size_t capacity) {
...
size_t tc_nodegraph_copy_edges(tc_nodegraph_handle graph, tc_nodegraph_edge_handle* out_handles, size_t capacity) {
    return access_graph(graph, size_t{0}, [&](GraphEntry& entry) {
...
size_t tc_nodegraph_copy_groups(tc_nodegraph_handle graph, tc_nodegraph_group_handle* out_handles, size_t capacity) {
    return access_graph(graph, size_t{0}, [&](GraphEntry& entry) {
...
tc_nodegraph_result tc_nodegraph_create_node(tc_nodegraph_handle graph,
    ...
    return access_graph(graph, TC_NODEGRAPH_INVALID_HANDLE, [&](GraphEntry& entry) {
        if (descriptor == nullptr || out_node == nullptr || descriptor->struct_size < sizeof(tc_nodegraph_node_desc) ||
...
tc_nodegraph_result tc_nodegraph_move_node(tc_nodegraph_handle graph, tc_nodegraph_node_handle node, float x, float y) {
    return access_graph(graph, TC_NODEGRAPH_INVALID_HANDLE, [&](GraphEntry& entry) {
...
tc_nodegraph_result
tc_nodegraph_set_node_data(tc_nodegraph_handle graph, tc_nodegraph_node_handle node, const tc_value* value) {
    return access_graph(graph, TC_NODEGRAPH_INVALID_HANDLE, [&](GraphEntry& entry) {
        if (value == nullptr)
...
tc_nodegraph_result tc_nodegraph_connect(tc_nodegraph_handle graph,
    ...
    return access_graph(graph, TC_NODEGRAPH_INVALID_HANDLE, [&](GraphEntry& entry) {
        ...
        auto result = entry.graph->connect(
            {from_c(source_node), source_socket, from_c(destination_node), destination_socket, edge_id ? edge_id : ""});
...
tc_nodegraph_result tc_nodegraph_create_group(tc_nodegraph_handle graph,
    ...
    return access_graph(graph, TC_NODEGRAPH_INVALID_HANDLE, [&](GraphEntry& entry) {
        if (descriptor == nullptr || out_group == nullptr || descriptor->struct_size < sizeof(tc_nodegraph_group_desc))
...
tc_nodegraph_result
tc_nodegraph_move_group(tc_nodegraph_handle graph, tc_nodegraph_group_handle group, float x, float y) {
    return access_graph(graph, TC_NODEGRAPH_INVALID_HANDLE, [&](GraphEntry& entry) {
...
tc_nodegraph_result
tc_nodegraph_set_group_data(tc_nodegraph_handle graph, tc_nodegraph_group_handle group, const tc_value* value) {
    return access_graph(graph, TC_NODEGRAPH_INVALID_HANDLE, [&](GraphEntry& entry) {
        if (value == nullptr)
...
tc_nodegraph_result
tc_nodegraph_copy_node_value(tc_nodegraph_handle graph, tc_nodegraph_node_handle node, tc_value* out_value) {
    return access_graph(graph, TC_NODEGRAPH_INVALID_HANDLE, [&](GraphEntry& entry) {
...
tc_nodegraph_result
tc_nodegraph_copy_edge_value(tc_nodegraph_handle graph, tc_nodegraph_edge_handle edge, tc_value* out_value) {
    return access_graph(graph, TC_NODEGRAPH_INVALID_HANDLE, [&](GraphEntry& entry) {
        if (out_value == nullptr)
...
tc_nodegraph_result
tc_nodegraph_copy_group_value(tc_nodegraph_handle graph, tc_nodegraph_group_handle group, tc_value* out_value) {
    return access_graph(graph, TC_NODEGRAPH_INVALID_HANDLE, [&](GraphEntry& entry) {
        if (out_value == nullptr)
