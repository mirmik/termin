...
NB_MODULE(_components_kinematic_native, m)
{
    ...
    nb::class_<ArticulationComponent, CxxComponent>(m,
                                                     "ArticulationComponent")
        .def("__init__",
             [](nb::handle self)
             { cxx_component_init<ArticulationComponent>(self); })
        ...
        .def_prop_ro(
            ...
            {
                return std::string(articulation_component_diagnostic_name(
        ...
        .def(
            "integrate_velocity",
            [](ArticulationComponent& component,
                ...
                -> robotics::Articulation3D&
            {
                ...
                if (articulation == nullptr)
                {
                    throw std::runtime_error(
                        "ArticulationComponent has not been rebuilt");
                }
                return *articulation;
            },
    ...
    nb::class_<KinematicUnitComponent, CxxComponent>(m,
    ...
    // ActuatorComponent
    nb::class_<ActuatorComponent, KinematicUnitComponent>(m,
                                                          "ActuatorComponent")
        .def("__init__",
             [](nb::handle self)
