...
private:
    ...
    static constexpr std::size_t invalid_body_index =
    ...
    [[nodiscard]] bool physics_pose_and_scale(
        Pose3& pose,
        Vec3& scale,
...
public:
    ...
    [[nodiscard]] physics::PhysicsWorld& physics_world() noexcept { return world_; }
    [[nodiscard]] const physics::PhysicsWorld& physics_world() const noexcept { return world_; }
