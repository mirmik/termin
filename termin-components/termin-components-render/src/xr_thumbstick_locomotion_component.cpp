...
namespace termin {
    ...
    namespace {
        ...
        void register_xr_thumbstick_locomotion_choice_fields(tc::InspectFacetBuilder& builder);
    ...
    void XrThumbstickLocomotionComponent::register_type() {
        auto descriptor = ComponentTypeDescriptorBuilder::native<XrThumbstickLocomotionComponent>(
            "XrThumbstickLocomotionComponent", "termin-components-render", "CxxComponent");
        descriptor.category("Input").require("XrOriginComponent");
        auto& inspect = descriptor.inspect();
        if (!inspect.find_field("XrThumbstickLocomotionComponent", "input_device_id")) {
            inspect.add<XrThumbstickLocomotionComponent, std::string>("XrThumbstickLocomotionComponent",
        ...
        if (!inspect.find_field("XrThumbstickLocomotionComponent", "move_speed")) {
            inspect.add<XrThumbstickLocomotionComponent, double>("XrThumbstickLocomotionComponent",
        ...
        if (!inspect.find_field("XrThumbstickLocomotionComponent", "normalize_diagonal")) {
            inspect.add<XrThumbstickLocomotionComponent, bool>("XrThumbstickLocomotionComponent",
        ...
        register_xr_thumbstick_locomotion_choice_fields(inspect);
    ...
    bool XrThumbstickLocomotionComponent::_read_thumbstick(const xr::XrRigInputState& input,
    ...
    void XrThumbstickLocomotionComponent::_apply_move(const xr::XrRigInputState& input, const Vec2& stick, double dt) {
    ...
    void XrThumbstickLocomotionComponent::_apply_turn(const xr::XrRigInputState& input, double dt) {
        ...
        const Quat orientation = Quat::from_axis_angle(Vec3{0.0, 0.0, 1.0}, yaw) * transform.global_rotation();
