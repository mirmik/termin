...
//
// Bone data rides a dedicated std140 UBO at binding=16. Plain `uniform mat4[]`
...
//
// BoneBlock binding is declared in the shader source (see
// docs/gpu-pipeline-layout.md for the struct layout). The Vulkan
// descriptor set layout is built from SPIR-V reflection; the binding
