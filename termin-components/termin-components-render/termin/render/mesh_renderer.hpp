...
namespace termin {
    ...
    public:
        ...
        MeshComponent* mesh_component() const {
            return _mesh_component;
        }

        TcMaterial get_material() const;
        tc_material* get_material_ptr() const;
        TcMaterial get_base_material() const {
            return material;
        }
        TcMaterial& get_material_ref() {
            return material;
        }
        const TcMaterial& get_material_ref() const {
            return material;
        }
