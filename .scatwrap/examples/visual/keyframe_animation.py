...
&nbsp;&nbsp;&nbsp;&nbsp;shader&nbsp;=&nbsp;TcShader.from_sources(VERT,&nbsp;FRAG,&nbsp;&quot;&quot;,&nbsp;&quot;KeyframeShader&quot;)<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;============<br>
&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;Keyframes&nbsp;(time,&nbsp;value)<br>
&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;============<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;движение&nbsp;по&nbsp;&quot;квадрату&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;trs_keys&nbsp;=&nbsp;[<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(0.0,&nbsp;np.array([1.5,&nbsp;0.0,&nbsp;0.0])),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(1.0,&nbsp;np.array([0.0,&nbsp;1.5,&nbsp;0.0])),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(2.0,&nbsp;np.array([-1.5,&nbsp;0.0,&nbsp;0.0])),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(3.0,&nbsp;np.array([0.0,&nbsp;-1.5,&nbsp;0.0])),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(4.0,&nbsp;np.array([1.5,&nbsp;0.0,&nbsp;0.0])),<br>
&nbsp;&nbsp;&nbsp;&nbsp;]<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;полный&nbsp;оборот&nbsp;вокруг&nbsp;Y&nbsp;за&nbsp;4&nbsp;секунды<br>
&nbsp;&nbsp;&nbsp;&nbsp;rot_keys&nbsp;=&nbsp;[<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(0.0,&nbsp;Pose3.rotateY(0.0).ang),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(1.0,&nbsp;Pose3.rotateY(np.pi/2).ang),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(2.0,&nbsp;Pose3.rotateY(np.pi).ang),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(3.0,&nbsp;Pose3.rotateY(1.5&nbsp;*&nbsp;np.pi).ang),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(4.0,&nbsp;Pose3.rotateY(2.0&nbsp;*&nbsp;np.pi).ang),<br>
&nbsp;&nbsp;&nbsp;&nbsp;]<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tps=1.0,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;channels={<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;clip&quot;:&nbsp;AnimationChannel(trs_keys,&nbsp;rot_keys,&nbsp;scale_keys)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;},<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;loop=True,<br>
&nbsp;&nbsp;&nbsp;&nbsp;)<br>
<br>
