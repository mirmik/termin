...
<br>
    camera1_entity = Entity(name=&quot;camera1&quot;)<br>
    camera1 = PerspectiveCameraComponent()<br>
    camera1_entity.add_component(camera1)<br>
    camera1_entity.add_component(OrbitCameraController())<br>
    scene.add(camera1_entity)<br>
<br>
    camera2_entity = Entity(name=&quot;camera2&quot;)<br>
    camera2 = PerspectiveCameraComponent()<br>
    camera2_entity.add_component(camera2)<br>
    camera2_entity.add_component(OrbitCameraController())<br>
    scene.add(camera2_entity)<br>
<br>
    return scene, camera1, camera2<br>
<br>
<br>
def main():<br>
    world = VisualizationWorld()<br>
    scene, camera1, camera2 = build_scene(world)<br>
    window1 = world.create_window(title=&quot;window1&quot;)<br>
    window2 = world.create_window(title=&quot;window2&quot;)<br>
    window1.add_viewport(scene, camera1)<br>
    window2.add_viewport(scene, camera2)<br>
    world.run()<br>
<br>
<br>
