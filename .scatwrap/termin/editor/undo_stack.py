...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;@property<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;done_commands(self)&nbsp;-&gt;&nbsp;List[UndoCommand]:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;Список&nbsp;выполненных&nbsp;команд&nbsp;(только&nbsp;для&nbsp;чтения).&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;list(self._done)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;@property<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;undone_commands(self)&nbsp;-&gt;&nbsp;List[UndoCommand]:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;Список&nbsp;отменённых&nbsp;команд&nbsp;(только&nbsp;для&nbsp;чтения).&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;list(self._undone)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;@property<br>
