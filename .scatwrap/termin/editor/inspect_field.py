...
&nbsp;&nbsp;&nbsp;&nbsp;kind&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;–&nbsp;тип&nbsp;виджета:&nbsp;'float',&nbsp;'int',&nbsp;'bool',&nbsp;'vec3',&nbsp;'color',&nbsp;'string',&nbsp;'enum',&nbsp;'button',&nbsp;...<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;is_serializable&nbsp;–&nbsp;при&nbsp;True&nbsp;поле&nbsp;сериализуется&nbsp;(default&nbsp;True)<br>
&nbsp;&nbsp;&nbsp;&nbsp;is_inspectable&nbsp;&nbsp;–&nbsp;при&nbsp;True&nbsp;поле&nbsp;показывается&nbsp;в&nbsp;инспекторе&nbsp;(default&nbsp;True)<br>
&nbsp;&nbsp;&nbsp;&nbsp;action&nbsp;&nbsp;&nbsp;&nbsp;–&nbsp;для&nbsp;kind='button':&nbsp;callable,&nbsp;вызывается&nbsp;при&nbsp;нажатии&nbsp;(принимает&nbsp;объект)<br>
&nbsp;&nbsp;&nbsp;&nbsp;read_only&nbsp;–&nbsp;виджет&nbsp;будет&nbsp;только&nbsp;для&nbsp;чтения<br>
&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;is_serializable:&nbsp;bool&nbsp;=&nbsp;True<br>
&nbsp;&nbsp;&nbsp;&nbsp;is_inspectable:&nbsp;bool&nbsp;=&nbsp;True<br>
&nbsp;&nbsp;&nbsp;&nbsp;action:&nbsp;Optional[Callable[[Any],&nbsp;None]]&nbsp;=&nbsp;None<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;InspectRegistry.instance().get(obj,&nbsp;self.path)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;set_value(self,&nbsp;obj,&nbsp;value):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;Convert&nbsp;None&nbsp;to&nbsp;appropriate&nbsp;default&nbsp;for&nbsp;the&nbsp;kind<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;value&nbsp;is&nbsp;None:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;self.kind&nbsp;==&nbsp;&quot;string&quot;:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;value&nbsp;=&nbsp;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;elif&nbsp;self.kind&nbsp;in&nbsp;(&quot;int&quot;,&nbsp;&quot;float&quot;):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;value&nbsp;=&nbsp;0<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;elif&nbsp;self.kind&nbsp;==&nbsp;&quot;bool&quot;:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;value&nbsp;=&nbsp;False<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;self.setter:<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;Use&nbsp;InspectRegistry.set()&nbsp;for&nbsp;proper&nbsp;kind&nbsp;handling&nbsp;(e.g.&nbsp;dict&nbsp;-&gt;&nbsp;MaterialHandle)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;try:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;from&nbsp;termin._native.inspect&nbsp;import&nbsp;InspectRegistry<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;InspectRegistry.instance().set(obj,&nbsp;self.path,&nbsp;value)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;except&nbsp;Exception&nbsp;as&nbsp;e:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;log.warn(e,&nbsp;f&quot;[InspectField]&nbsp;falling&nbsp;back&nbsp;to&nbsp;setattr&nbsp;for&nbsp;'{self.path}'&quot;)<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return<br>
&nbsp;&nbsp;&nbsp;&nbsp;except&nbsp;Exception&nbsp;as&nbsp;e:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;log.debug(f&quot;[InspectField]&nbsp;numpy&nbsp;in-place&nbsp;update&nbsp;failed&nbsp;for&nbsp;'{path}':&nbsp;{e}&quot;)<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;getter=getter,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setter=setter,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;is_serializable=is_serializable,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;is_inspectable=is_inspectable,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;action=action,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;read_only=read_only,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;Важно:&nbsp;проверяем,&nbsp;что&nbsp;dict&nbsp;принадлежит&nbsp;именно&nbsp;этому&nbsp;классу,&nbsp;а&nbsp;не&nbsp;унаследован<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;&quot;inspect_fields&quot;&nbsp;not&nbsp;in&nbsp;owner.__dict__:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fields&nbsp;=&nbsp;{}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setattr(owner,&nbsp;&quot;inspect_fields&quot;,&nbsp;fields)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;else:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fields&nbsp;=&nbsp;owner.__dict__[&quot;inspect_fields&quot;]<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;meta&nbsp;→&nbsp;параметры&nbsp;для&nbsp;InspectField&nbsp;(label,&nbsp;kind,&nbsp;min,&nbsp;max,&nbsp;step,&nbsp;is_serializable,&nbsp;is_inspectable,&nbsp;...)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;<br>
