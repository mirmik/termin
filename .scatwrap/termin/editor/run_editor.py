...
from&nbsp;termin.visualization.core.lighting.light&nbsp;import&nbsp;LightType,&nbsp;LightShadowParams<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;panel&nbsp;=&nbsp;Entity(pose=Pose3.identity(),&nbsp;name=&quot;cube2&quot;)<br>
&nbsp;&nbsp;&nbsp;&nbsp;panel.add_component(MeshRenderer(drawable,&nbsp;blue_material))<br>
&nbsp;&nbsp;&nbsp;&nbsp;panel.transform.relocate(Pose3(lin=np.array([0.0,&nbsp;0.0,&nbsp;-3.0]),&nbsp;ang=np.array([0.0,&nbsp;0.0,&nbsp;0.0,&nbsp;1.0])))<br>
&nbsp;&nbsp;&nbsp;&nbsp;panel.scale&nbsp;=&nbsp;np.array([10.0,&nbsp;10.0,&nbsp;0.1])<br>
&nbsp;&nbsp;&nbsp;&nbsp;scene.add(panel)<br>
<br>
<br>
