...
Работает&nbsp;в&nbsp;диапазоне&nbsp;0-1&nbsp;для&nbsp;RGB.<br>
<br>
...
from&nbsp;PyQt5.QtCore&nbsp;import&nbsp;Qt,&nbsp;pyqtSignal,&nbsp;QPoint,&nbsp;QRect,&nbsp;QSize<br>
<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;QImage()<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;image&nbsp;=&nbsp;QImage(w,&nbsp;h,&nbsp;QImage.Format_RGB32)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for&nbsp;y&nbsp;in&nbsp;range(h):<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;painter.setPen(QPen(Qt.white,&nbsp;2))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;painter.drawRect(marker_rect)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;painter.setPen(QPen(Qt.black,&nbsp;1))<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;Подписи<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;painter.setPen(Qt.black&nbsp;if&nbsp;self._old_color.lightnessF()&nbsp;&gt;&nbsp;0.5&nbsp;else&nbsp;Qt.white)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;painter.drawText(QRect(0,&nbsp;0,&nbsp;w&nbsp;//&nbsp;2,&nbsp;h),&nbsp;Qt.AlignCenter,&nbsp;&quot;Old&quot;)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;painter.setPen(Qt.black&nbsp;if&nbsp;self._new_color.lightnessF()&nbsp;&gt;&nbsp;0.5&nbsp;else&nbsp;Qt.white)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;painter.drawText(QRect(w&nbsp;//&nbsp;2,&nbsp;0,&nbsp;w&nbsp;-&nbsp;w&nbsp;//&nbsp;2,&nbsp;h),&nbsp;Qt.AlignCenter,&nbsp;&quot;New&quot;)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;painter.end()<br>
<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;dlg.exec_()&nbsp;==&nbsp;QDialog.Accepted:<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self._r_slider&nbsp;=&nbsp;QSlider(Qt.Horizontal)<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self._g_slider&nbsp;=&nbsp;QSlider(Qt.Horizontal)<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self._b_slider&nbsp;=&nbsp;QSlider(Qt.Horizontal)<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self._a_slider&nbsp;=&nbsp;QSlider(Qt.Horizontal)<br>
