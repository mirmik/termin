...
import&nbsp;numpy<br>
import&nbsp;math<br>
from&nbsp;termin.geombase._geom_native&nbsp;import&nbsp;Pose3,&nbsp;Vec3<br>
<br>
def&nbsp;_to_numpy(v):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;Convert&nbsp;Vec3&nbsp;or&nbsp;array-like&nbsp;to&nbsp;numpy&nbsp;array.&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;isinstance(v,&nbsp;numpy.ndarray):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;v<br>
&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;isinstance(v,&nbsp;Vec3):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;numpy.array([v.x,&nbsp;v.y,&nbsp;v.z],&nbsp;dtype=numpy.float64)<br>
&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;numpy.asarray(v,&nbsp;dtype=numpy.float64)<br>
<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;__slots__&nbsp;=&nbsp;('ang',&nbsp;'lin')<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;__init__(self,&nbsp;ang,&nbsp;lin):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;Convert&nbsp;to&nbsp;numpy&nbsp;if&nbsp;needed<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.ang&nbsp;=&nbsp;_to_numpy(ang)&nbsp;&nbsp;#&nbsp;Bivector&nbsp;part<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.lin&nbsp;=&nbsp;_to_numpy(lin)&nbsp;&nbsp;#&nbsp;Vector&nbsp;part<br>
<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;copy(self)&nbsp;-&gt;&nbsp;&quot;Screw2&quot;:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;Create&nbsp;a&nbsp;copy&nbsp;of&nbsp;the&nbsp;Screw2.&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw2(ang=self.ang.copy(),&nbsp;lin=self.lin.copy())<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;@staticmethod<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;zero()&nbsp;-&gt;&nbsp;&quot;Screw3&quot;:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;Create&nbsp;a&nbsp;zero&nbsp;screw.&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(ang=numpy.zeros(3,&nbsp;dtype=numpy.float64),&nbsp;lin=numpy.zeros(3,&nbsp;dtype=numpy.float64))<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;copy(self)&nbsp;-&gt;&nbsp;&quot;Screw3&quot;:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;Create&nbsp;a&nbsp;copy&nbsp;of&nbsp;the&nbsp;Screw3.&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(ang=self.ang.copy(),&nbsp;lin=self.lin.copy())<br>
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;transform_by(self,&nbsp;trans):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ang=_to_numpy(trans.transform_vector(self.ang)),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lin=_to_numpy(trans.transform_vector(self.lin))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;rotate_by(self,&nbsp;rot):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ang=_to_numpy(rot.transform_vector(self.ang)),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lin=_to_numpy(rot.transform_vector(self.lin))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;inverse_rotate_by(self,&nbsp;rot):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ang=_to_numpy(rot.inverse_transform_vector(self.ang)),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lin=_to_numpy(rot.inverse_transform_vector(self.lin))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;inverse_transform_by(self,&nbsp;trans):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ang=_to_numpy(trans.inverse_transform_vector(self.ang)),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lin=_to_numpy(trans.inverse_transform_vector(self.lin))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;transform_as_twist_by(self,&nbsp;trans):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rang&nbsp;=&nbsp;_to_numpy(trans.transform_vector(self.ang))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;trans_lin&nbsp;=&nbsp;_to_numpy(trans.lin)&nbsp;if&nbsp;isinstance(trans.lin,&nbsp;Vec3)&nbsp;else&nbsp;trans.lin<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ang&nbsp;=&nbsp;rang,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lin&nbsp;=&nbsp;_to_numpy(trans.transform_vector(self.lin))&nbsp;+&nbsp;numpy.cross(trans_lin,&nbsp;rang)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;inverse_transform_as_twist_by(self,&nbsp;trans):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;trans_lin&nbsp;=&nbsp;_to_numpy(trans.lin)&nbsp;if&nbsp;isinstance(trans.lin,&nbsp;Vec3)&nbsp;else&nbsp;trans.lin<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ang&nbsp;=&nbsp;_to_numpy(trans.inverse_transform_vector(self.ang)),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lin&nbsp;=&nbsp;_to_numpy(trans.inverse_transform_vector(self.lin&nbsp;-&nbsp;numpy.cross(trans_lin,&nbsp;self.ang)))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;transform_as_wrench_by(self,&nbsp;trans):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;Transform&nbsp;wrench&nbsp;(moment&nbsp;+&nbsp;force)&nbsp;under&nbsp;SE(3)&nbsp;transform.&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;p&nbsp;=&nbsp;_to_numpy(trans.lin)&nbsp;if&nbsp;isinstance(trans.lin,&nbsp;Vec3)&nbsp;else&nbsp;trans.lin<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ang&nbsp;=&nbsp;_to_numpy(trans.transform_vector(self.ang&nbsp;+&nbsp;numpy.cross(p,&nbsp;self.lin))),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lin&nbsp;=&nbsp;_to_numpy(trans.transform_vector(self.lin))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;inverse_transform_as_wrench_by(self,&nbsp;trans):<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;p&nbsp;=&nbsp;_to_numpy(trans.lin)&nbsp;if&nbsp;isinstance(trans.lin,&nbsp;Vec3)&nbsp;else&nbsp;trans.lin<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ang&nbsp;=&nbsp;_to_numpy(trans.inverse_transform_vector(self.ang&nbsp;-&nbsp;numpy.cross(p,&nbsp;self.lin))),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lin&nbsp;=&nbsp;_to_numpy(trans.inverse_transform_vector(self.lin))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br>
<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;__rmul__(self,&nbsp;oth):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(self.ang&nbsp;*&nbsp;oth,&nbsp;self.lin&nbsp;*&nbsp;oth)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;__add__(self,&nbsp;oth):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(self.ang&nbsp;+&nbsp;oth.ang,&nbsp;self.lin&nbsp;+&nbsp;oth.lin)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;__sub__(self,&nbsp;oth):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(self.ang&nbsp;-&nbsp;oth.ang,&nbsp;self.lin&nbsp;-&nbsp;oth.lin)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;__neg__(self):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(-self.ang,&nbsp;-self.lin)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;dot(self,&nbsp;oth:&nbsp;&quot;Screw3&quot;)&nbsp;-&gt;&nbsp;float:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;Dot&nbsp;product&nbsp;of&nbsp;two&nbsp;screws&nbsp;(for&nbsp;power&nbsp;computation:&nbsp;wrench&nbsp;·&nbsp;twist).&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;numpy.dot(self.ang,&nbsp;oth.ang)&nbsp;+&nbsp;numpy.dot(self.lin,&nbsp;oth.lin)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;cross_motion(self,&nbsp;oth:&nbsp;&quot;Screw3&quot;)&nbsp;-&gt;&nbsp;&quot;Screw3&quot;:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Spatial&nbsp;cross&nbsp;product&nbsp;for&nbsp;motion&nbsp;vectors&nbsp;(twist&nbsp;×&nbsp;twist).<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ω₁&nbsp;×&nbsp;ω₂,&nbsp;ω₁&nbsp;×&nbsp;v₂&nbsp;+&nbsp;v₁&nbsp;×&nbsp;ω₂]<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ang=numpy.cross(self.ang,&nbsp;oth.ang),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lin=numpy.cross(self.ang,&nbsp;oth.lin)&nbsp;+&nbsp;numpy.cross(self.lin,&nbsp;oth.ang)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;cross_force(self,&nbsp;oth:&nbsp;&quot;Screw3&quot;)&nbsp;-&gt;&nbsp;&quot;Screw3&quot;:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Spatial&nbsp;cross&nbsp;product&nbsp;for&nbsp;force&nbsp;vectors&nbsp;(twist&nbsp;×*&nbsp;wrench).<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ω&nbsp;×&nbsp;τ&nbsp;+&nbsp;v&nbsp;×&nbsp;f,&nbsp;ω&nbsp;×&nbsp;f]<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;Screw3(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ang=numpy.cross(self.ang,&nbsp;oth.ang)&nbsp;+&nbsp;numpy.cross(self.lin,&nbsp;oth.lin),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lin=numpy.cross(self.ang,&nbsp;oth.lin)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)<br>
<br>
