...
uniform&nbsp;sampler2D&nbsp;u_albedo_texture;&nbsp;//&nbsp;Текстура&nbsp;цвета&nbsp;(белая&nbsp;1x1&nbsp;по&nbsp;умолчанию)<br>
uniform&nbsp;float&nbsp;u_shininess;&nbsp;//&nbsp;Размер&nbsp;блика&nbsp;(1-128)<br>
<br>
...
<br>
//&nbsp;==============&nbsp;Ambient&nbsp;lighting&nbsp;(scene-level)&nbsp;==============<br>
...
uniform&nbsp;sampler2DShadow&nbsp;u_shadow_map[MAX_SHADOW_MAPS];&nbsp;&nbsp;//&nbsp;Hardware&nbsp;PCF<br>
...
<br>
/**<br>
&nbsp;*&nbsp;Вычисляет&nbsp;коэффициент&nbsp;тени&nbsp;для&nbsp;источника&nbsp;света&nbsp;с&nbsp;hardware&nbsp;PCF.<br>
&nbsp;*<br>
&nbsp;*&nbsp;Использует&nbsp;sampler2DShadow&nbsp;для&nbsp;аппаратного&nbsp;сравнения&nbsp;глубины.<br>
&nbsp;*&nbsp;texture()&nbsp;возвращает&nbsp;результат&nbsp;сравнения&nbsp;с&nbsp;билинейной&nbsp;интерполяцией.<br>
&nbsp;*<br>
&nbsp;*&nbsp;Возвращает:<br>
&nbsp;*&nbsp;&nbsp;&nbsp;1.0&nbsp;—&nbsp;фрагмент&nbsp;освещён<br>
&nbsp;*&nbsp;&nbsp;&nbsp;0.0&nbsp;—&nbsp;фрагмент&nbsp;в&nbsp;тени<br>
&nbsp;*/<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;float&nbsp;shadow&nbsp;=&nbsp;sample_shadow_map(sm,&nbsp;vec3(proj_coords.xy,&nbsp;proj_coords.z&nbsp;-&nbsp;SHADOW_BIAS));<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;shadow;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;1.0;<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Scene-level&nbsp;ambient&nbsp;lighting<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Вычисляем&nbsp;тень&nbsp;для&nbsp;directional&nbsp;lights<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;float&nbsp;shadow&nbsp;=&nbsp;1.0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(type&nbsp;==&nbsp;LIGHT_TYPE_DIRECTIONAL)&nbsp;{<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Применяем&nbsp;тень&nbsp;к&nbsp;диффузу&nbsp;и&nbsp;спекуляру<br>
...
<br>
<br>
def&nbsp;create_default_material(<br>
&nbsp;&nbsp;&nbsp;&nbsp;name:&nbsp;str&nbsp;=&nbsp;&quot;DefaultMaterial&quot;,<br>
&nbsp;&nbsp;&nbsp;&nbsp;color:&nbsp;tuple[float,&nbsp;float,&nbsp;float,&nbsp;float]&nbsp;|&nbsp;None&nbsp;=&nbsp;None,<br>
)&nbsp;-&gt;&nbsp;TcMaterial:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;Создаёт&nbsp;материал&nbsp;по&nbsp;умолчанию&nbsp;с&nbsp;диффузным&nbsp;освещением&nbsp;по&nbsp;Ламберту&nbsp;и&nbsp;бликом&nbsp;по&nbsp;Фонгу.<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;Args:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;name:&nbsp;Имя&nbsp;материала.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;color:&nbsp;RGBA&nbsp;цвет&nbsp;(по&nbsp;умолчанию&nbsp;белый).<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;Returns:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TcMaterial&nbsp;с&nbsp;одной&nbsp;фазой&nbsp;&quot;opaque&quot;.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;from&nbsp;termin.visualization.render.texture&nbsp;import&nbsp;get_white_texture<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;mat&nbsp;=&nbsp;TcMaterial.create(name,&nbsp;&quot;&quot;)<br>
&nbsp;&nbsp;&nbsp;&nbsp;mat.shader_name&nbsp;=&nbsp;&quot;DefaultShader&quot;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;Add&nbsp;opaque&nbsp;phase<br>
&nbsp;&nbsp;&nbsp;&nbsp;state&nbsp;=&nbsp;TcRenderState.opaque()<br>
&nbsp;&nbsp;&nbsp;&nbsp;phase&nbsp;=&nbsp;mat.add_phase_from_sources(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vertex_source=DEFAULT_VERT,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fragment_source=DEFAULT_FRAG,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;geometry_source=&quot;&quot;,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;shader_name=&quot;DefaultShader&quot;,<br>
...
<br>
<br>
class&nbsp;DefaultMaterial(TcMaterial):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;Базовый&nbsp;материал&nbsp;сцены.&nbsp;Диффузная&nbsp;часть&nbsp;следует&nbsp;модели&nbsp;Ламберта,&nbsp;блик&nbsp;—&nbsp;Фонга.<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;NOTE:&nbsp;This&nbsp;is&nbsp;a&nbsp;factory&nbsp;class&nbsp;that&nbsp;returns&nbsp;TcMaterial.<br>
&nbsp;&nbsp;&nbsp;&nbsp;Use&nbsp;create_default_material()&nbsp;for&nbsp;explicit&nbsp;creation.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;__new__(cls,&nbsp;color:&nbsp;tuple[float,&nbsp;float,&nbsp;float,&nbsp;float]&nbsp;|&nbsp;None&nbsp;=&nbsp;None)&nbsp;-&gt;&nbsp;TcMaterial:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;create_default_material(name=&quot;DefaultMaterial&quot;,&nbsp;color=color)<br>
<!-- END SCAT CODE -->
</body>
</html>
