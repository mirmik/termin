...
<br>
/**<br>
&nbsp;*&nbsp;Вычисляет&nbsp;коэффициент&nbsp;тени&nbsp;для&nbsp;источника&nbsp;света.<br>
&nbsp;*<br>
&nbsp;*&nbsp;Алгоритм:<br>
&nbsp;*&nbsp;1.&nbsp;Преобразуем&nbsp;мировую&nbsp;позицию&nbsp;в&nbsp;light-space:&nbsp;p_light&nbsp;=&nbsp;L&nbsp;*&nbsp;p_world<br>
&nbsp;*&nbsp;2.&nbsp;Переводим&nbsp;в&nbsp;NDC:&nbsp;ndc&nbsp;=&nbsp;p_light.xyz&nbsp;/&nbsp;p_light.w<br>
&nbsp;*&nbsp;3.&nbsp;Переводим&nbsp;в&nbsp;текстурные&nbsp;координаты:&nbsp;uv&nbsp;=&nbsp;ndc.xy&nbsp;*&nbsp;0.5&nbsp;+&nbsp;0.5<br>
&nbsp;*&nbsp;4.&nbsp;Сравниваем&nbsp;глубину&nbsp;фрагмента&nbsp;с&nbsp;глубиной&nbsp;в&nbsp;shadow&nbsp;map<br>
&nbsp;*<br>
&nbsp;*&nbsp;Возвращает:<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Ищем&nbsp;shadow&nbsp;map&nbsp;для&nbsp;этого&nbsp;источника<br>
&nbsp;&nbsp;&nbsp;&nbsp;for&nbsp;(int&nbsp;sm&nbsp;=&nbsp;0;&nbsp;sm&nbsp;&lt;&nbsp;u_shadow_map_count;&nbsp;++sm)&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(u_shadow_light_index[sm]&nbsp;!=&nbsp;light_index)&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;continue;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Преобразуем&nbsp;в&nbsp;light-space<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vec4&nbsp;light_space_pos&nbsp;=&nbsp;u_light_space_matrix[sm]&nbsp;*&nbsp;vec4(v_world_pos,&nbsp;1.0);<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Perspective&nbsp;divide&nbsp;(для&nbsp;ортографической&nbsp;проекции&nbsp;w=1,&nbsp;но&nbsp;делаем&nbsp;для&nbsp;общности)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vec3&nbsp;proj_coords&nbsp;=&nbsp;light_space_pos.xyz&nbsp;/&nbsp;light_space_pos.w;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Переводим&nbsp;из&nbsp;[-1,&nbsp;1]&nbsp;в&nbsp;[0,&nbsp;1]&nbsp;для&nbsp;текстурных&nbsp;координат<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;proj_coords&nbsp;=&nbsp;proj_coords&nbsp;*&nbsp;0.5&nbsp;+&nbsp;0.5;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Проверяем,&nbsp;что&nbsp;координаты&nbsp;внутри&nbsp;shadow&nbsp;map<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(proj_coords.x&nbsp;&lt;&nbsp;0.0&nbsp;||&nbsp;proj_coords.x&nbsp;&gt;&nbsp;1.0&nbsp;||<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;proj_coords.y&nbsp;&lt;&nbsp;0.0&nbsp;||&nbsp;proj_coords.y&nbsp;&gt;&nbsp;1.0&nbsp;||<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;proj_coords.z&nbsp;&lt;&nbsp;0.0&nbsp;||&nbsp;proj_coords.z&nbsp;&gt;&nbsp;1.0)&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;1.0;&nbsp;//&nbsp;Вне&nbsp;frustum'а&nbsp;—&nbsp;считаем&nbsp;освещённым<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Читаем&nbsp;глубину&nbsp;из&nbsp;shadow&nbsp;map&nbsp;(записана&nbsp;в&nbsp;R&nbsp;канал&nbsp;как&nbsp;серый&nbsp;цвет)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;float&nbsp;closest_depth&nbsp;=&nbsp;texture(u_shadow_map[sm],&nbsp;proj_coords.xy).r;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Текущая&nbsp;глубина&nbsp;фрагмента<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;float&nbsp;current_depth&nbsp;=&nbsp;proj_coords.z;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Сравниваем&nbsp;с&nbsp;bias&nbsp;для&nbsp;устранения&nbsp;shadow&nbsp;acne<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;float&nbsp;shadow&nbsp;=&nbsp;current_depth&nbsp;-&nbsp;SHADOW_BIAS&nbsp;&gt;&nbsp;closest_depth&nbsp;?&nbsp;0.0&nbsp;:&nbsp;1.0;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;shadow;<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Нет&nbsp;shadow&nbsp;map&nbsp;для&nbsp;этого&nbsp;источника&nbsp;—&nbsp;полностью&nbsp;освещён<br>
&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;1.0;<br>
}<br>
<br>
void&nbsp;main()&nbsp;{<br>
