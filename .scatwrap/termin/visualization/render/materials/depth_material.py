...
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;v_linear_depth&nbsp;=&nbsp;depth;&nbsp;&nbsp;//&nbsp;❗&nbsp;БЕЗ&nbsp;clamp<br>
...
<br>
void&nbsp;main()&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;float&nbsp;d&nbsp;=&nbsp;v_linear_depth;<br>
&nbsp;&nbsp;&nbsp;&nbsp;<br>
&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Отладка<br>
&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(d&nbsp;&lt;&nbsp;0.0)&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FragColor&nbsp;=&nbsp;vec4(1.0,&nbsp;0.0,&nbsp;0.0,&nbsp;1.0);&nbsp;&nbsp;//&nbsp;RED&nbsp;=&nbsp;behind&nbsp;camera<br>
&nbsp;&nbsp;&nbsp;&nbsp;}&nbsp;else&nbsp;if&nbsp;(d&nbsp;&gt;&nbsp;1.0)&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FragColor&nbsp;=&nbsp;vec4(0.0,&nbsp;0.0,&nbsp;1.0,&nbsp;1.0);&nbsp;&nbsp;//&nbsp;BLUE&nbsp;=&nbsp;too&nbsp;far<br>
&nbsp;&nbsp;&nbsp;&nbsp;}&nbsp;else&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FragColor&nbsp;=&nbsp;vec4(d,&nbsp;d,&nbsp;d,&nbsp;1.0);&nbsp;&nbsp;//&nbsp;GRAY&nbsp;=&nbsp;ok<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
}<br>
&quot;&quot;&quot;<br>
<br>
