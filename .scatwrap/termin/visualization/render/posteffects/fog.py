...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;inspect_fields&nbsp;=&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;fog_color&quot;:&nbsp;InspectField(path=&quot;_fog_color&quot;,&nbsp;label=&quot;Fog&nbsp;Color&quot;,&nbsp;kind=&quot;color&quot;),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;fog_start&quot;:&nbsp;InspectField(path=&quot;_fog_start&quot;,&nbsp;label=&quot;Fog&nbsp;Start&quot;,&nbsp;kind=&quot;float&quot;,&nbsp;min=0.0,&nbsp;max=1.0,&nbsp;step=0.01),<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;fog_end&quot;:&nbsp;InspectField(path=&quot;_fog_end&quot;,&nbsp;label=&quot;Fog&nbsp;End&quot;,&nbsp;kind=&quot;float&quot;,&nbsp;min=0.0,&nbsp;max=1.0,&nbsp;step=0.01),<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;__init__(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self,<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self._shader&nbsp;=&nbsp;TcShader.from_sources(FOG_VERT,&nbsp;FOG_FRAG,&nbsp;&quot;&quot;,&nbsp;&quot;FogEffect&quot;)<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;fc&nbsp;=&nbsp;self._fog_color<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;shader.set_uniform_vec3(&quot;u_fog_color&quot;,&nbsp;float(fc[0]),&nbsp;float(fc[1]),&nbsp;float(fc[2]))<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;shader.set_uniform_float(&quot;u_fog_start&quot;,&nbsp;self._fog_start&nbsp;if&nbsp;depth_tex&nbsp;else&nbsp;1.0)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;shader.set_uniform_float(&quot;u_fog_end&quot;,&nbsp;self._fog_end&nbsp;if&nbsp;depth_tex&nbsp;else&nbsp;1.0)<br>
<br>
