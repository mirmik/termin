...
<head>
  <meta charset="UTF-8">
  <title>termin/visualization/render/posteffects/highlight.py</title>
</head>
<body>
<!-- BEGIN SCAT CODE -->
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;inspect_fields&nbsp;=&nbsp;{<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;color&quot;:&nbsp;InspectField(path=&quot;_color&quot;,&nbsp;label=&quot;Outline&nbsp;Color&quot;,&nbsp;kind=&quot;color&quot;),<br>
&nbsp;&nbsp;&nbsp;&nbsp;}<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;__init__(self,&nbsp;selected_id_getter=None,&nbsp;color=(0.0,&nbsp;0.0,&nbsp;0.0,&nbsp;1.0)):<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;selected_id_getter:&nbsp;callable&nbsp;-&gt;&nbsp;int&nbsp;|&nbsp;None<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(например,&nbsp;лямбда,&nbsp;которая&nbsp;читает&nbsp;selected_entity_id&nbsp;из&nbsp;редактора)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Note:&nbsp;selected_id_getter&nbsp;—&nbsp;runtime&nbsp;callback,&nbsp;не&nbsp;сериализуется.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self._shader&nbsp;=&nbsp;TcShader.from_sources(HIGHLIGHT_VERT,&nbsp;HIGHLIGHT_FRAG,&nbsp;&quot;&quot;,&nbsp;&quot;HighlightEffect&quot;)<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;selected_id&nbsp;=&nbsp;self._get_id()&nbsp;if&nbsp;self._get_id&nbsp;else&nbsp;0<br>
<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;sel_color&nbsp;=&nbsp;id_to_rgb(selected_id)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;shader.set_uniform_vec3(&quot;u_selected_color&quot;,&nbsp;float(sel_color[0]),&nbsp;float(sel_color[1]),&nbsp;float(sel_color[2]))<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;texel_x&nbsp;=&nbsp;1.0&nbsp;/&nbsp;max(1,&nbsp;w)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;texel_y&nbsp;=&nbsp;1.0&nbsp;/&nbsp;max(1,&nbsp;h)<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;shader.set_uniform_vec2(&quot;u_texel_size&quot;,&nbsp;texel_x,&nbsp;texel_y)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;oc&nbsp;=&nbsp;self._color<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;shader.set_uniform_vec3(&quot;u_outline_color&quot;,&nbsp;float(oc[0]),&nbsp;float(oc[1]),&nbsp;float(oc[2]))<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;gfx.draw_ui_textured_quad()<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;clear_callbacks(self)&nbsp;-&gt;&nbsp;None:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;Clear&nbsp;callback&nbsp;to&nbsp;allow&nbsp;garbage&nbsp;collection.&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self._get_id&nbsp;=&nbsp;None<br>
<!-- END SCAT CODE -->
</body>
</html>
