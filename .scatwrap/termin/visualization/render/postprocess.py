...
from&nbsp;termin.visualization.render.framegraph&nbsp;import&nbsp;FrameContext,&nbsp;RenderFramePass,&nbsp;blit_fbo_to_fbo<br>
<br>
<br>
class&nbsp;PostEffect:<br>
&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;debug_fb&nbsp;=&nbsp;window.get_viewport_fbo(viewport,&nbsp;debug_output,&nbsp;size)<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self._blit_to_debug(gfx,&nbsp;fb_in,&nbsp;debug_fb,&nbsp;size,&nbsp;key)<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self._blit_to_debug(gfx,&nbsp;fb_target,&nbsp;debug_fb,&nbsp;size,&nbsp;key)<br>
<br>
