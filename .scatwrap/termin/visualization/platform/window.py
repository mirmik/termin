...
from&nbsp;termin.visualization.render.pipeline_runner&nbsp;import&nbsp;PipelineRunner<br>
<br>
class&nbsp;Window:<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.pipeline_runner&nbsp;=&nbsp;PipelineRunner(self.graphics)<br>
<br>
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.pipeline_runner.render_viewports(<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.viewports,<br>
