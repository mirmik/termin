...
&nbsp;&nbsp;&nbsp;&nbsp;&quot;&quot;&quot;Rotate&nbsp;vector&nbsp;v&nbsp;by&nbsp;quaternion&nbsp;q&nbsp;using&nbsp;optimized&nbsp;formula.&quot;&quot;&quot;<br>
&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;q&nbsp;=&nbsp;(qx,&nbsp;qy,&nbsp;qz,&nbsp;qw)<br>
&nbsp;&nbsp;&nbsp;&nbsp;qx,&nbsp;qy,&nbsp;qz,&nbsp;qw&nbsp;=&nbsp;q[0],&nbsp;q[1],&nbsp;q[2],&nbsp;q[3]<br>
&nbsp;&nbsp;&nbsp;&nbsp;vx,&nbsp;vy,&nbsp;vz&nbsp;=&nbsp;v[0],&nbsp;v[1],&nbsp;v[2]<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;t&nbsp;=&nbsp;2&nbsp;*&nbsp;cross(q.xyz,&nbsp;v)<br>
&nbsp;&nbsp;&nbsp;&nbsp;tx&nbsp;=&nbsp;2.0&nbsp;*&nbsp;(qy&nbsp;*&nbsp;vz&nbsp;-&nbsp;qz&nbsp;*&nbsp;vy)<br>
&nbsp;&nbsp;&nbsp;&nbsp;ty&nbsp;=&nbsp;2.0&nbsp;*&nbsp;(qz&nbsp;*&nbsp;vx&nbsp;-&nbsp;qx&nbsp;*&nbsp;vz)<br>
&nbsp;&nbsp;&nbsp;&nbsp;tz&nbsp;=&nbsp;2.0&nbsp;*&nbsp;(qx&nbsp;*&nbsp;vy&nbsp;-&nbsp;qy&nbsp;*&nbsp;vx)<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;result&nbsp;=&nbsp;v&nbsp;+&nbsp;qw&nbsp;*&nbsp;t&nbsp;+&nbsp;cross(q.xyz,&nbsp;t)<br>
&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;numpy.array([<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vx&nbsp;+&nbsp;qw&nbsp;*&nbsp;tx&nbsp;+&nbsp;qy&nbsp;*&nbsp;tz&nbsp;-&nbsp;qz&nbsp;*&nbsp;ty,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vy&nbsp;+&nbsp;qw&nbsp;*&nbsp;ty&nbsp;+&nbsp;qz&nbsp;*&nbsp;tx&nbsp;-&nbsp;qx&nbsp;*&nbsp;tz,<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;vz&nbsp;+&nbsp;qw&nbsp;*&nbsp;tz&nbsp;+&nbsp;qx&nbsp;*&nbsp;ty&nbsp;-&nbsp;qy&nbsp;*&nbsp;tx,<br>
&nbsp;&nbsp;&nbsp;&nbsp;])<br>
<br>
