...
// No GPU layouts, no tc_mesh - just vertices and triangles.
...
public:
    ...
    CpuMesh3(std::vector<Vec3f> verts, std::vector<uint32_t> tris,
    ...
    // Copy
    CpuMesh3 copy(const std::string& new_name = "") const {
        CpuMesh3 result;
