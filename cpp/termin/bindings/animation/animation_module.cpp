...
void register_animation_kind_handlers() {
    ...
    registry.register_kind("animation_clip_handle", KindHandler{
        // serialize
        [](py::object obj) -> nos::trent {
            if (py::isinstance<AnimationClipHandle>(obj)) {
        ...
        [](const nos::trent& t) -> py::object {
            ...
            if (t.is_string()) {
                return py::cast(AnimationClipHandle::from_uuid(t.as_string()));
            }
            // Handle dict format
            if (t.is_dict()) {
