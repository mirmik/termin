...
using Message =
    std::variant<ClientHello, TargetHello, Control, Status, DictionaryAdd,
                 FrameBatch, GapEvent, DropEvent, ErrorEvent>;
...
TERMIN_PROFILER_REMOTE_API bool version_is_compatible(std::uint16_t major,
                                                      std::uint16_t minor);
...
TERMIN_PROFILER_REMOTE_API CodecResult<Envelope>
...
TERMIN_PROFILER_REMOTE_API CodecResult<DecodedMessage>
