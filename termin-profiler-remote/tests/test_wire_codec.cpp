...
TEST_CASE("Version-one golden bytes cover every message type") {
  const std::vector<std::pair<Message, std::string>> cases = {
      ...
      {Control{}, "54505246 0001 0000 0003 0000 00000012 0000000000000001 "
                  "0000000000000002 "
      ...
      {DictionaryAdd{}, "54505246 0001 0000 0005 0000 00000004 "
                        "0000000000000001 0000000000000002 "
                        "00000000"},
      {FrameBatch{}, "54505246 0001 0000 0006 0000 00000004 0000000000000001 "
                     "0000000000000002 "
                     "00000000"},
      {GapEvent{}, "54505246 0001 0000 0007 0000 00000019 0000000000000001 "
                   "0000000000000002 "
      ...
      {ErrorEvent{1, 0, "x"}, "54505246 0001 0000 0009 0000 0000000f "
                              "0000000000000001 0000000000000002 "
...
TEST_CASE("Invalid section structure and boolean values are rejected") {
  ...
  CHECK(encode_message(FrameBatch{{frame}}, 1, 2).error ==
