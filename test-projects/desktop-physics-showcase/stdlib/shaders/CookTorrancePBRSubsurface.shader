@program CookTorrancePBRSubsurface
@language slang
@features lighting_ubo

// Artistic forward Cook-Torrance PBR with wrapped diffuse subsurface.
//
// This shader intentionally remains a final-color material. It preserves the
// pre-surface-contract CookTorrancePBR look for skin and other materials that
// depend on u_subsurface or u_diffuse_mul.
