...
- `world-controller-scene-cycle`: playable two-room portal walk for Editor
  Play, source-player, and packaged desktop verification of identity-based
  `WorldController` navigation and retained inactive scenes.
