...
class PostProcessPass(RenderFramePass):
    def __init__(self, effects, input_res: str, output_res: str, pass_name: str = "PostProcess"):
        ...
        self.effects = effects # TODO: Временно принимаем ссылку на внешний объект
        self.input_res = input_res
        self.output_res = output_res
