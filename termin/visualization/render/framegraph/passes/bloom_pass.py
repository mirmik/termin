...
This is a complex pass with internal FBO state for the mip chain.
"""
...
# ================================================================
#          DOWNSAMPLE PASS - 13-tap filter (Karis average)
# ================================================================
...
# ================================================================
#          UPSAMPLE PASS - 9-tap tent filter with additive blend
# ================================================================
...
class BloomPass(PostEffectPass):
    ...
    Uses mip-chain approach: extract bright -> downsample -> upsample -> composite.
    This creates wide, smooth bloom with good performance.

    For best results, use with HDR framebuffer (RGBA16F) and
    ...
    def _ensure_mip_fbos(
        ...
        format_str: str = "rgba16f",
    ) -> None:
        """Ensure FBOs exist for each mip level."""
        w, h = base_size
    ...
    def apply(
        ...
        """Execute bloom with progressive downsample/upsample."""
        w, h = size
        mip_count = int(self.mip_levels)
        ...
        for i in range(1, mip_count):
            ...
            graphics.bind_framebuffer(dst_fbo)
