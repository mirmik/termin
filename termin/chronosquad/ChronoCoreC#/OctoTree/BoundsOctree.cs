...
public class BoundsOctree<T>
{
    ...
    public void Add(T obj, Bounds objBounds)
    {
        ...
        while (!rootNode.Add(obj, objBounds))
        {
            ...
            {
                Debug.LogError(
                    "Aborted Add operation as it seemed to be going on forever ("
                        + (count - 1)
    ...
    void Grow(Vector3 direction)
    {
        ...
        Vector3 newCenter =
            rootNode.Center + new Vector3(xDirection * half, yDirection * half, zDirection * half);
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                else
                {
                    ...
                    children[i] = new BoundsOctreeNode<T>(
                        ...
                        looseness,
                        newCenter
                            + new Vector3(xDirection * half, yDirection * half, zDirection * half)
                    );
                }
            }
