...
public class BracedMovingAnimatronic : Animatronic
{
    ...
    public BracedMovingAnimatronic(
        ReferencedPose pose_a,
        ReferencedPose pose_b,
        long start_step,
        long finish_step,
    ...
    public override bool IsBraced(ITimeline tl, long step)
    {
        return true;
    }
    ...
    public override bool Equals(object obj)
    {
        ...
        if (obj.GetType() != GetType())
            return false;
        var other = obj as BracedMovingAnimatronic;
