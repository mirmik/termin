...
// [Serializable]
// public class ReverseFourDCommand : ActorCommand
// {
...
// 			copy.CommandBuffer().GetCommandQueue().Remove(
// 				typeof(ReverseInTimeCommand), StartStep);
...
// 			ntc.DropLastTimelineStep(copy_is_reversed ? TimeDirection.Backward : TimeDirection.Forward);
// 		};
...
// 		return false;
// 	var other = obj as ReverseFourDCommand;
// 	return
// 		active_is_reversed == other.active_is_reversed &&
