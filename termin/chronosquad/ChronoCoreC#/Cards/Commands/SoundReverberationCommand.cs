...
public class SoundReverberationCommand : ThrowToEnvironmentCommand
{
    public float radius_of_sound = 2;

    public SoundReverberationCommand(
    ...
    override protected void AddEvents(ObjectOfTimeline actor, ITimeline tl)
    {
        ...
        var shoot_event = new ShootEffectEvent(
    ...
    public override bool Equals(object obj)
    {
        ...
        if (obj.GetType() != GetType())
            return false;
        var other = obj as SoundReverberationCommand;
