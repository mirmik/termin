...
public class PermanentStunCommand : ShootCommand
{
    public string slug_name;

    public override void KillTarget(ObjectOfTimeline actor, ITimeline tl, float absolute_offset)
    {
        Debug.Log("PermanentStunCommand.KillTarget");
    }

    public PermanentStunCommand(ObjectId target_actor, float shoot_distance, long stamp)
    ...
    public override bool Equals(object obj)
    {
        ...
        if (obj.GetType() != GetType())
            return false;
        var other = obj as PermanentStunCommand;
