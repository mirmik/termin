...
public class JumpAction : OneAbilityAction
{
    public Material LineMaterial;

    public JumpAction() : base(KeyCode.B) { }
    ...
    Vector3 TargetDirection(Actor guard, Vector3 target_position)
    {
        ...
        var closest = GameCore.GetClosestActor(
            target_position,
    ...
    public override void OnEnvironmentClick(ClickInformation click)
    {
        ...
        _actor.GetObject().AbilityUseOnEnvironment<JumpAbility>(rpos);
        Cancel();
    }
    ...
    public override void OnActorClick(GameObject actor, ClickInformation click)
    {
        ...
        _actor.GetObject().AbilityUseOnObject<JumpAbility>(obj);
