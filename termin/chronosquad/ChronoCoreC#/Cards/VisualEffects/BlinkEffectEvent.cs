...
class BlinkEffectEvent : GlobalEvent
{
    Vector3 position1;
    Vector3 position2;
    ...
    public override void on_enter(long current_step, ITimeline tl)
    {
        ...
        sphere1.transform.position = position1 + new Vector3(0, 0.9f, 0);
        sphere1.GetComponent<Renderer>().material = material;
        sphere1.layer = 13;

        if (sphere2 == null)
            sphere2 = GameObject.CreatePrimitive(PrimitiveType.Sphere);
        sphere2.transform.localScale = new Vector3(1.8f, 1.8f, 1.8f);
        sphere2.transform.position = position2 + new Vector3(0, 0.9f, 0);
    ...
    public override bool Equals(object obj)
    {
        ...
        if (obj.GetType() != GetType())
            return false;
        var other = obj as BlinkEffectEvent;
