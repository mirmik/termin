...
_repo_components_dir = _os.path.abspath(
    _os.path.join(
...
if _os.path.isdir(_repo_components_dir) and _repo_components_dir not in __path__:
    __path__.append(_repo_components_dir)
