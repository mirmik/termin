...
## Шаг 4: Проецируем центры на плоскость (с опциональной сшивкой)

**Вход:** центры вокселей (3D), плоскость, (опционально) информация о регионах

**Алгоритм без сшивки:** `projected = point - dot(point - plane_point, normal) * normal`
