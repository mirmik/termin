...
namespace termin {
    ...
    ComponentTypeDescriptorBuilder::ComponentTypeDescriptorBuilder(const char* type_name,
                                                                   const char* owner,
                                                                   const char* parent,
    ...
    ComponentTypeDescriptorBuilder::ComponentTypeDescriptorBuilder(ComponentTypeDescriptorBuilder&& other) noexcept
    ...
    ComponentTypeDescriptorBuilder& ComponentTypeDescriptorBuilder::require(std::string type_name) {
        if (type_name.empty())
            ...
            _requirements.push_back(std::move(type_name));
        return *this;
    }
    ...
    bool ComponentTypeDescriptorBuilder::commit() {
        ...
        for (const std::string& requirement : _requirements)
            requirements.push_back(requirement.c_str());
        if (!tc_component_type_descriptor_add_facet(_descriptor,
                                                    &_factory,
                                                    _kind,
                                                    _abstract,
                                                    _display_name.c_str(),
