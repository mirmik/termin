...
namespace termin {
    ...
    TERMIN_ENGINE_API TcSceneRef create_scene_with_extensions(const std::string& name,
    ...
    TERMIN_ENGINE_API TcSceneRef deserialize_scene_with_render(const nos::trent& data, const std::string& name = "");
