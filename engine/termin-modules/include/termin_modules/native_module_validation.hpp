...
namespace termin_modules {
    ...
    TERMIN_MODULES_API termin_native_module_host_v1 make_native_module_host_v1(const char* module_id,
                                                                               void* host_context = nullptr);

    TERMIN_MODULES_API NativeModuleValidationResult validate_native_module_descriptor_v1(
        const termin_native_module_descriptor_v1_data* descriptor, const std::string& expected_module_id = {});
