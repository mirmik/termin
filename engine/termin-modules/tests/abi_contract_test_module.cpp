...
namespace {
    ...
    int32_t failing_init(const termin_native_module_host_v1*, termin_native_module_error* error) {
    ...
    int32_t retrying_shutdown(const termin_native_module_host_v1*, termin_native_module_error* error) {
        ++g_shutdown_attempts;
...
extern "C" TERMIN_NATIVE_MODULE_EXPORT const termin_native_module_descriptor_v1_data termin_module_descriptor_v1 = {
...
TERMIN_NATIVE_MODULE_DESCRIPTOR_V1(
    "abi_init_failure", "1.0.0", "abi-init-failure-test", TERMIN_NATIVE_MODULE_CAP_NONE, failing_init, ok_shutdown);
#elif defined(TERMIN_ABI_TEST_SHUTDOWN_RETRY)
TERMIN_NATIVE_MODULE_DESCRIPTOR_V1("abi_shutdown_retry",
                                   "1.0.0",
