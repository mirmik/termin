...
namespace termin::voxels {
    ...
    TERMIN_VOXELS_API bool
    triangle_aabb_intersect(Vec3 v0, Vec3 v1, Vec3 v2, const Vec3& box_center, const Vec3& box_half_size);

    TERMIN_VOXELS_API Vec3 compute_triangle_normal(const Vec3& v0, const Vec3& v1, const Vec3& v2);
    ...
    public:
        VoxelGrid(double cell_size = 0.25,
