...
class AssetRuntimeManager:
    ...
    def ensure_runtime_asset_registry(
        self,
        type_id: str,
        asset_class,
        data_from_asset,
        ...
        """Create a plugin-owned runtime registry once and return it.

        Optional domain adapters use this hook to install their asset type only
        when the corresponding runtime plugin is actually exercised.  Product
        resource managers therefore do not need to know every installable asset
        domain in advance.
        """
