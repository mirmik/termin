...
namespace termin {
    ...
    public:
        ...
        INSPECT_TYPE_METADATA(PresentToScreenPass, graph, make_pass_graph_metadata({{"input_res", "fbo"}}, {}, {}))

        PresentToScreenPass(const std::string& input = "color", const std::string& output = "OUTPUT");
