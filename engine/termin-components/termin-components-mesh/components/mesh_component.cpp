...
namespace termin {
    ...
    void MeshComponent::register_type() {
        ...
        if (!inspect.find_field("MeshComponent", "mesh_generated")) {
            tc::InspectFieldSpec spec =
                tc::inspect_field_spec("MeshComponent", "mesh_generated", "Generated Mesh", "bool");
            spec.is_inspectable = false;
            inspect.add_with_callbacks<MeshComponent, bool>(
                spec,
                [](MeshComponent* c) { return c->mesh_is_generated(); },
                [](MeshComponent* c, bool generated) { c->_set_mesh_generated_from_serialization(generated); });
        }
        ...
        if (!inspect.find_field("MeshComponent", "mesh_offset_position")) {
            inspect.add_with_callbacks<MeshComponent, tc_vec3>(
                ...
                [](MeshComponent* c, const tc_vec3& value) { c->set_mesh_offset_position(value); });
        }
        if (!inspect.find_field("MeshComponent", "mesh_offset_euler")) {
            inspect.add_with_callbacks<MeshComponent, tc_vec3>(
                ...
                [](MeshComponent* c, const tc_vec3& value) { c->set_mesh_offset_euler(value); });
        }
        if (!inspect.find_field("MeshComponent", "mesh_offset_scale")) {
            inspect.add_with_callbacks<MeshComponent, tc_vec3>(
                ...
                [](MeshComponent* c, const tc_vec3& value) { c->set_mesh_offset_scale(value); });
        }
    ...
    void MeshComponent::deserialize_data(const tc_value* data, tc_scene_handle scene) {
        ...
        tc_value* generated_value = tc_value_dict_get(const_cast<tc_value*>(data), "mesh_generated");
        const bool generated = generated_value && generated_value->type == TC_VALUE_BOOL && generated_value->data.b;
        if (!generated) {
            CxxComponent::deserialize_data(data, scene);
            return;
        }
