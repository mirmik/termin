...
namespace termin {
    ...
    inline constexpr const char* TC_EVENT_MESH_COMPONENT_CHANGED = "termin.mesh_component.changed";
    ...
    public:
        ...
        bool mesh_is_generated() const {
            return _mesh_generated;
        }
        uint64_t mesh_revision() const {
            return _mesh_revision;
        }
