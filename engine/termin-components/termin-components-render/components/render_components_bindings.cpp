...
namespace termin {
    ...
    template <typename T> nb::object init_pass_from_deserialize(T* pass, const char* type_name) {
    ...
    template <typename T> void bind_xr_cxx_component_common(nb::class_<T, CxxComponent>& binding) {
        binding.def("__init__", [](nb::handle self) { cxx_component_init<T>(self); })
            .def("c_component_ptr",
                 [](T& component) -> uintptr_t { return reinterpret_cast<uintptr_t>(component.c_component()); })
            .def("_cxx_component_ptr",
                 [](T& component) -> uintptr_t { return reinterpret_cast<uintptr_t>(&component); })
            .def_static("_from_c_component_ptr",
                        [](uintptr_t ptr) -> nb::object {
                            if (ptr == 0)
                                return nb::none();
    ...
    static void set_material_from_python(MaterialPass& pass, nb::object material_obj) {
        ...
        if (nb::isinstance<nb::dict>(material_obj)) {
            ...
            tc::Log::error(
                "[render_components] Material reference not found: uuid=%s name=%s", uuid.c_str(), name.c_str());
            pass.material = TcMaterial();
            return;
        }
...
NB_MODULE(_components_render_native, m) {
    ...
    nb::class_<TcSpriteAsset>(m, "TcSpriteAsset")
        .def(nb::init<>())
        .def_static("declare", &TcSpriteAsset::declare, nb::arg("uuid"), nb::arg("name"), nb::arg("source_path") = "")
        .def_static("from_uuid", &TcSpriteAsset::from_uuid)
        .def("update",
             &TcSpriteAsset::update,
             nb::arg("texture_uuid"),
             nb::arg("region"),
             nb::arg("source_width"),
    ...
    nb::class_<Camera>(m, "Camera")
        ...
        .def_static("perspective",
                    ...
                    nb::arg("near") = 0.1,
                    nb::arg("far") = 100.0)
        .def_static("perspective_deg",
                    &Camera::perspective_deg,
                    nb::arg("fov_y_deg"),
                    nb::arg("aspect"),
                    nb::arg("near") = 0.1,
                    nb::arg("far") = 100.0)
        ...
        .def_static("view_matrix", &Camera::view_matrix, nb::arg("position"), nb::arg("rotation"))
        .def_static(
            "view_matrix_look_at",
            [](const Vec3& eye, const Vec3& target, std::optional<Vec3> up) {
                return Camera::view_matrix_look_at(eye, target, up.value_or(Vec3::unit_z()));
            },
            nb::arg("eye"),
            nb::arg("target"),
    ...
    nb::class_<CameraComponent, CxxComponent>(m, "CameraComponent")
        .def("__init__", [](nb::handle self) { cxx_component_init<CameraComponent>(self); })
        .def_prop_rw(
            "projection_type", &CameraComponent::get_projection_type_str, &CameraComponent::set_projection_type_str)
        ...
        .def_prop_rw("fov_mode", &CameraComponent::get_fov_mode_str, &CameraComponent::set_fov_mode_str)
        .def_rw("fov_x", &CameraComponent::fov_x)
        .def_rw("fov_y", &CameraComponent::fov_y)
        .def_prop_rw("fov_x_degrees", &CameraComponent::get_fov_x_degrees, &CameraComponent::set_fov_x_degrees)
        .def_prop_rw("fov_y_degrees", &CameraComponent::get_fov_y_degrees, &CameraComponent::set_fov_y_degrees)
        ...
        .def(
            "add_viewport",
            [](CameraComponent& c, nb::object viewport) {
        ...
        .def_prop_ro("viewport",
                     [](CameraComponent& c) -> nb::object {
    ...
    m.def(
        ...
        [](double fov_degrees, double aspect, double near, double far) {
    ...
    m.def(
        ...
        [](double ortho_size, double aspect, double near, double far) {
            auto* cam = new CameraComponent();
    ...
    nb::class_<XrOriginComponent, CxxComponent>(m, "XrOriginComponent")
        .def("__init__", [](nb::handle self) { cxx_component_init<XrOriginComponent>(self); })
        .def_prop_rw(
            "reference_space", &XrOriginComponent::get_reference_space_str, &XrOriginComponent::set_reference_space_str)
        ...
        .def("c_component_ptr",
             [](XrOriginComponent& c) -> uintptr_t { return reinterpret_cast<uintptr_t>(c.c_component()); })
        .def("_cxx_component_ptr", [](XrOriginComponent& c) -> uintptr_t { return reinterpret_cast<uintptr_t>(&c); })
        .def_static("_from_c_component_ptr",
                    [](uintptr_t ptr) -> nb::object {
                        if (ptr == 0) {
                            return nb::none();
    ...
    nb::class_<XrThumbstickLocomotionComponent, CxxComponent>(m, "XrThumbstickLocomotionComponent")
        .def("__init__", [](nb::handle self) { cxx_component_init<XrThumbstickLocomotionComponent>(self); })
        ...
        .def("c_component_ptr",
             [](XrThumbstickLocomotionComponent& c) -> uintptr_t {
                 return reinterpret_cast<uintptr_t>(c.c_component());
             })
        .def("_cxx_component_ptr",
             [](XrThumbstickLocomotionComponent& c) -> uintptr_t { return reinterpret_cast<uintptr_t>(&c); })
        .def_static("_from_c_component_ptr",
                    [](uintptr_t ptr) -> nb::object {
                        if (ptr == 0) {
                            return nb::none();
    ...
    tracked_pose_binding.def_rw("input_device_id", &XrTrackedPoseComponent::input_device_id)
        .def_prop_rw("hand", &XrTrackedPoseComponent::get_hand_str, &XrTrackedPoseComponent::set_hand_str)
        .def_prop_rw(
            "pose_kind", &XrTrackedPoseComponent::get_pose_kind_str, &XrTrackedPoseComponent::set_pose_kind_str)
        .def_prop_ro("tracking_active", &XrTrackedPoseComponent::tracking_active);

    nb::class_<XrGrabInteractableComponent, CxxComponent> interactable_binding(m, "XrGrabInteractableComponent");
    bind_xr_cxx_component_common(interactable_binding);
    interactable_binding.def_rw("grab_radius", &XrGrabInteractableComponent::grab_radius)
        .def_rw("grabbable", &XrGrabInteractableComponent::grabbable)
        .def_prop_ro("grabbed", &XrGrabInteractableComponent::grabbed);

    nb::class_<XrDirectGrabInteractorComponent, CxxComponent> interactor_binding(m, "XrDirectGrabInteractorComponent");
    bind_xr_cxx_component_common(interactor_binding);
    interactor_binding.def_rw("reach", &XrDirectGrabInteractorComponent::reach)
    ...
    nb::class_<XrRayInteractorComponent, CxxComponent> ray_interactor_binding(m, "XrRayInteractorComponent");
    bind_xr_cxx_component_common(ray_interactor_binding);
    ray_interactor_binding.def_rw("max_distance", &XrRayInteractorComponent::max_distance)
        ...
        .def_prop_ro("visible_ray_length", &XrRayInteractorComponent::visible_ray_length);

    nb::class_<MeshRenderer, Component>(m, "MeshRenderer")
        .def("__init__", [](nb::handle self) { cxx_component_init<MeshRenderer>(self); })
        .def(
            "__init__",
            [](nb::handle self, nb::object material_arg, bool cast_shadow) {
        ...
        .def_prop_ro("materials", [](MeshRenderer& self) { return self.materials; })
    ...
    nb::class_<SkinnedMeshRenderer, MeshRenderer>(m, "SkinnedMeshRenderer")
        .def("__init__", [](nb::handle self) { cxx_component_init<SkinnedMeshRenderer>(self); })
        .def(
            "__init__",
            [](nb::handle self, nb::object material_arg, SkeletonController* skeleton_controller, bool cast_shadow) {
        ...
        .def("get_bone_matrices_flat", [](SkinnedMeshRenderer& self) {
            ...
            std::copy(self._bone_matrices_flat.data(), self._bone_matrices_flat.data() + data_size, buf);
    ...
    nb::class_<WorldTextComponent, Component>(m, "WorldTextComponent")
        .def("__init__", [](nb::handle self) { cxx_component_init<WorldTextComponent>(self); })
        .def(
            "__init__",
            [](nb::handle self,
            ...
            nb::arg("font_path") = "")
        .def_prop_rw(
            "text", [](WorldTextComponent& self) { return self.text; }, &WorldTextComponent::set_text)
        .def_prop_rw(
            "font_path", [](WorldTextComponent& self) { return self.font_path; }, &WorldTextComponent::set_font_path)
        .def_prop_rw(
            "phase_mark", [](WorldTextComponent& self) { return self.phase_mark; }, &WorldTextComponent::set_phase_mark)
        .def_prop_rw(
            "local_offset",
            [](WorldTextComponent& self) { return self.local_offset; },
            [](WorldTextComponent& self, const Vec3& value) { self.set_local_offset(value); })
        .def_prop_rw(
            "plane_normal",
            [](WorldTextComponent& self) { return self.plane_normal; },
            [](WorldTextComponent& self, const Vec3& value) { self.set_plane_normal(value); })
        .def_prop_rw(
            "text_up",
            [](WorldTextComponent& self) { return self.text_up; },
        ...
        .def_prop_rw(
            "anchor", [](WorldTextComponent& self) { return self.anchor; }, &WorldTextComponent::set_anchor)
        ...
        .def_prop_rw(
            "orientation_name", &WorldTextComponent::orientation_name, &WorldTextComponent::set_orientation_name)
        .def_prop_rw(
            "priority", [](WorldTextComponent& self) { return self.priority; }, &WorldTextComponent::set_priority)
        .def_prop_rw(
            "depth_test", [](WorldTextComponent& self) { return self.depth_test; }, &WorldTextComponent::set_depth_test)
        .def_prop_rw(
            "depth_write",
            [](WorldTextComponent& self) { return self.depth_write; },
            &WorldTextComponent::set_depth_write)
        .def_prop_rw(
            "blend", [](WorldTextComponent& self) { return self.blend; }, &WorldTextComponent::set_blend)
        .def_prop_rw(
            "cull", [](WorldTextComponent& self) { return self.cull; }, &WorldTextComponent::set_cull)
    ...
    nb::class_<SpriteRenderer2D, Component>(m, "SpriteRenderer2D")
        .def("__init__", [](nb::handle self) { cxx_component_init<SpriteRenderer2D>(self); })
        .def_prop_rw(
            "sprite_uuid",
            [](const SpriteRenderer2D& self) { return self.sprite_uuid; },
            &SpriteRenderer2D::set_sprite_uuid)
        .def_prop_rw(
            "tint", [](const SpriteRenderer2D& self) { return self.tint; }, &SpriteRenderer2D::set_tint)
        .def_prop_rw(
            "flip_x", [](const SpriteRenderer2D& self) { return self.flip_x; }, &SpriteRenderer2D::set_flip_x)
        .def_prop_rw(
            "flip_y", [](const SpriteRenderer2D& self) { return self.flip_y; }, &SpriteRenderer2D::set_flip_y)
        .def_prop_rw(
            "sorting_layer",
        ...
        .def_prop_rw(
            "visible", [](const SpriteRenderer2D& self) { return self.visible; }, &SpriteRenderer2D::set_visible)
    ...
    nb::class_<LightComponent, CxxComponent>(m, "LightComponent")
        .def("__init__", [](nb::handle self) { cxx_component_init<LightComponent>(self); })
        .def_prop_rw("light_type", &LightComponent::get_light_type_str, &LightComponent::set_light_type_str)
        .def_prop_rw(
            "color",
            [](const LightComponent& c) { return c.color; },
            [](LightComponent& c, const Vec3& v) { c.color = v; })
        .def_rw("intensity", &LightComponent::intensity)
        .def_prop_rw("shadows_enabled", &LightComponent::get_shadows_enabled, &LightComponent::set_shadows_enabled)
        .def_prop_rw("shadows_bias", &LightComponent::get_shadows_bias, &LightComponent::set_shadows_bias)
        .def_prop_rw(
            "shadows_normal_bias", &LightComponent::get_shadows_normal_bias, &LightComponent::set_shadows_normal_bias)
        .def_prop_rw("shadows_map_resolution",
                     &LightComponent::get_shadows_map_resolution,
                     &LightComponent::set_shadows_map_resolution)
        .def_prop_rw("cascade_count", &LightComponent::get_cascade_count, &LightComponent::set_cascade_count)
        .def_prop_rw("max_distance", &LightComponent::get_max_distance, &LightComponent::set_max_distance)
        .def_prop_rw("split_lambda", &LightComponent::get_split_lambda, &LightComponent::set_split_lambda)
        .def_prop_rw("cascade_blend", &LightComponent::get_cascade_blend, &LightComponent::set_cascade_blend)
        .def_rw("shadows", &LightComponent::shadows)
        .def("to_light", &LightComponent::to_light)
        .def("c_component_ptr",
             [](LightComponent& c) -> uintptr_t { return reinterpret_cast<uintptr_t>(c.c_component()); });
    ...
    nb::class_<DepthPass, CxxFramePass>(m, "DepthPass")
        ...
        .def_static(
            "_deserialize_instance",
            [](nb::dict data, nb::object resource_manager) {
                ...
                if (data.contains("data")) {
                    ...
                    if (d.contains("phase_mark"))
                        phase_mark = nb::cast<std::string>(d["phase_mark"]);
                    else if (d.contains("material_phase_mark"))
                        phase_mark = nb::cast<std::string>(d["material_phase_mark"]);
                    if (d.contains("depth_encoding"))
                        depth_encoding = nb::cast<std::string>(d["depth_encoding"]);
                    if (d.contains("clear"))
                        clear = nb::cast<bool>(d["clear"]);
                }
    ...
    nb::class_<DepthOnlyPass, CxxFramePass>(m, "DepthOnlyPass")
        .def(
            "__init__",
            [](DepthOnlyPass* self, const std::string& output_res, const std::string& pass_name) {
                new (self) DepthOnlyPass(output_res, pass_name);
                init_pass_from_python(self, "DepthOnlyPass");
            },
            nb::arg("output_res") = "depth_texture",
            nb::arg("pass_name") = "DepthOnly")
        ...
        .def_static(
            ...
            [](nb::dict data, nb::object resource_manager) {
                ...
                if (data.contains("data")) {
                    ...
                    if (d.contains("output_res"))
                        output_res = nb::cast<std::string>(d["output_res"]);
                    if (d.contains("output_res_target"))
                        output_res_target = nb::cast<std::string>(d["output_res_target"]);
                    if (d.contains("phase_mark"))
                        phase_mark = nb::cast<std::string>(d["phase_mark"]);
                    else if (d.contains("material_phase_mark"))
                        phase_mark = nb::cast<std::string>(d["material_phase_mark"]);
...

    {
        ...
        m.attr("DepthOnlyPass").attr("node_inputs") =
            nb::make_tuple(nb::make_tuple("output_res_target", "depth_texture"));
        m.attr("DepthOnlyPass").attr("node_outputs") = nb::make_tuple(nb::make_tuple("output_res", "depth_texture"));
        m.attr("DepthOnlyPass").attr("node_inplace_pairs") =
    ...
    nb::class_<DepthToColorPass, CxxFramePass>(m, "DepthToColorPass")
        .def(
            ...
            nb::arg("input_res") = "depth_texture",
            nb::arg("output_res") = "depth_color",
            nb::arg("pass_name") = "DepthToColor")
...

    {
        ...
        m.attr("DepthToColorPass").attr("node_inputs") = nb::make_tuple(
            nb::make_tuple("input_res", "depth_texture"), nb::make_tuple("output_res_target", "color_texture"));
        m.attr("DepthToColorPass").attr("node_outputs") = nb::make_tuple(nb::make_tuple("output_res", "color_texture"));
        m.attr("DepthToColorPass").attr("node_inplace_pairs") =
            nb::make_tuple(nb::make_tuple("output_res_target", "output_res"));
    }
    ...
    nb::class_<ColorToDepthPass, CxxFramePass>(m, "ColorToDepthPass")
        .def(
            ...
            nb::arg("input_res") = "color_texture",
            nb::arg("output_res") = "depth_texture",
            nb::arg("pass_name") = "ColorToDepth")
...

    {
        ...
        m.attr("ColorToDepthPass").attr("node_inputs") = nb::make_tuple(
            nb::make_tuple("input_res", "color_texture"), nb::make_tuple("output_res_target", "depth_texture"));
        m.attr("ColorToDepthPass").attr("node_outputs") = nb::make_tuple(nb::make_tuple("output_res", "depth_texture"));
        m.attr("ColorToDepthPass").attr("node_inplace_pairs") =
            nb::make_tuple(nb::make_tuple("output_res_target", "output_res"));
    }
    ...
    nb::class_<MaterialPass, CxxFramePass>(m, "MaterialPass")
        .def(
            "__init__",
            [](MaterialPass* self, const std::string& output_res, nb::object material, const std::string& pass_name) {
            ...
            nb::arg("material") = nb::none(),
            nb::arg("pass_name") = "MaterialPass")
        .def_rw("output_res", &MaterialPass::output_res)
        .def_rw("output_res_target", &MaterialPass::output_res_target)
        .def_prop_rw(
            "material",
            [](MaterialPass& self) -> TcMaterial { return self.material; },
            [](MaterialPass& self, nb::object material) { set_material_from_python(self, material); })
        .def_rw("texture_resources", &MaterialPass::texture_resources)
        .def_rw("extra_resources", &MaterialPass::extra_resources)
        .def("set_texture_resource",
             &MaterialPass::set_texture_resource,
             nb::arg("uniform_name"),
             nb::arg("resource_name"))
        .def("add_resource", &MaterialPass::add_resource, nb::arg("resource_name"), nb::arg("uniform_name") = "")
        .def("remove_resource", &MaterialPass::remove_resource, nb::arg("resource_name"))
        .def("get_internal_symbols", &MaterialPass::get_internal_symbols)
        .def(
            "execute_with_data",
            [](MaterialPass& self, nb::tuple rect_py) {
                ExecuteContext ctx;
            ...
            [](nb::dict data, nb::object resource_manager) {
                ...
                if (data.contains("data")) {
                    ...
                    if (d.contains("material"))
                        material = nb::borrow<nb::object>(d["material"]);
                }
...

    {
        ...
        m.attr("MaterialPass").attr("node_inputs") = nb::make_tuple(nb::make_tuple("output_res_target", "fbo"));
        m.attr("MaterialPass").attr("node_outputs") = nb::make_tuple(nb::make_tuple("output_res", "fbo"));
        m.attr("MaterialPass").attr("node_inplace_pairs") =
            nb::make_tuple(nb::make_tuple("output_res_target", "output_res"));
