...
namespace termin {
    ...
    void XrOriginComponent::register_type() {
        ...
        if (!inspect.find_field("XrOriginComponent", "near_clip")) {
            inspect.add<XrOriginComponent, double>(
                "XrOriginComponent", &XrOriginComponent::near_clip, "near_clip", "Near Clip", "double");
        }
        if (!inspect.find_field("XrOriginComponent", "far_clip")) {
            inspect.add<XrOriginComponent, double>(
                "XrOriginComponent", &XrOriginComponent::far_clip, "far_clip", "Far Clip", "double");
        }
    ...
    std::string XrOriginComponent::get_reference_space_str() const {
        ...
        case XrReferenceSpace::Stage:
            return "stage";
        case XrReferenceSpace::Local:
            return "local";
        }
        return "local";
    }
    ...
    std::string XrOriginComponent::get_reference_alignment_str() const {
        ...
        case XrReferenceAlignment::StageAxes:
            return "stage_axes";
        case XrReferenceAlignment::InitialHeadYaw:
