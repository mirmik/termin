...
namespace termin {
    ...
    class ENTITY_API GeometryPassBase : public CxxFramePass, public SceneShaderUsageProvider {
    public:
        struct DrawCall {
        public:
            Entity entity;
    ...
    protected:
        ...
        INSPECT_TYPE_METADATA(GeometryPassBase,
                              graph,
    ...
    protected:
        GeometryPassBase(const std::string& name, const std::string& input, const std::string& output);
