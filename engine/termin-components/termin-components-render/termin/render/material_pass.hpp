...
namespace termin {
    ...
    public:
        ...
        INSPECT_TYPE_METADATA(MaterialPass,
                              graph,
                              make_pass_graph_metadata({{"output_res_target", "fbo"}},
                                                       {{"output_res", "fbo"}},
    ...
    SERIALIZABLE_FIELD(MaterialPass,
                       texture_resources,
                       serialize_texture_resources(),
                       deserialize_texture_resources(val))
