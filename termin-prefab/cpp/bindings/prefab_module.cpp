...
namespace {
    ...
    nb::object encode_python_node(nb::object value, size_t depth = 0) {
        ...
        if (nb::isinstance<nb::dict>(value)) {
            ...
            for (auto item : nb::cast<nb::dict>(value)) {
                ...
                entry["value"] = encode_python_node(nb::borrow<nb::object>(item.second), depth + 1);
        ...
        if (nb::isinstance(value, numpy.attr("ndarray"))) {
            ...
            nb::list shape;
            for (nb::handle dimension : value.attr("shape"))
    ...
    nb::object decode_python_node(nb::dict node) {
        ...
        if (tag == "none")
            return nb::none();
        if (tag == "bool")
            return nb::borrow<nb::object>(node["value"]);
        if (tag == "int64")
            return nb::module_::import_("builtins").attr("int")(node["value"]);
        if (tag == "uint64")
            return nb::module_::import_("builtins").attr("int")(node["value"]);
        if (tag == "float64")
            return nb::module_::import_("builtins").attr("float")(node["value"]);
        if (tag == "string")
            return nb::borrow<nb::object>(node["value"]);
        ...
        if (tag == "kind") {
            nb::object registry = nb::module_::import_("termin.inspect").attr("KindRegistry").attr("instance")();
    ...
    termin::prefab::PrefabOverrideValue
    encode_python_override(nb::object value, nb::object explicit_kind, nb::object resource_type) {
        nb::object node;
        if (!explicit_kind.is_none()) {
            const std::string kind = nb::cast<std::string>(explicit_kind);
            if (kind.empty())
                throw nb::value_error("override kind must not be empty");
            nb::object registry = nb::module_::import_("termin.inspect").attr("KindRegistry").attr("instance")();
            const bool has_python_kind = nb::cast<bool>(registry.attr("has_python")(kind));
            nb::object payload = has_python_kind ? registry.attr("serialize")(kind, value) : value;
            if (!resource_type.is_none()) {
                if (!has_python_kind) {
                    throw nb::value_error("resource override kind requires a registered Python serializer");
                }
    ...
    class PythonBindingResourceResolver final : public termin::prefab::PrefabOverrideResourceResolver {
    public:
...
NB_MODULE(_prefab_native, m) {
    ...
    nb::class_<termin::prefab::PrefabOverrideValue>(m, "PrefabOverrideValue")
        ...
        .def_static("from_python",
                    &encode_python_override,
                    nb::arg("value").none(),
                    nb::arg("kind") = nb::none(),
        ...
        .def("to_data",
             [](const termin::prefab::PrefabOverrideValue& value) {
                 return nb::module_::import_("json").attr("loads")(value.to_json());
             })
        .def("to_python", [](const termin::prefab::PrefabOverrideValue& value) {
            nb::dict envelope = nb::cast<nb::dict>(nb::module_::import_("json").attr("loads")(value.to_json()));
    ...
    nb::class_<termin::prefab::PrefabStructureReference>(m, "PrefabStructureReference")
        ...
        .def_rw("local_component_source_id", &termin::prefab::PrefabStructureReference::local_component_source_id);
    ...
    nb::class_<termin::prefab::PrefabInstanceState, termin::CxxComponent>(m, "PrefabInstanceState")
        .def(
            "__init__",
            [](nb::handle self, const std::string& prefab_asset_uuid) {
                termin::prefab::register_prefab_component_types();
                termin::cxx_component_init<termin::prefab::PrefabInstanceState>(self, prefab_asset_uuid);
            },
            nb::arg("prefab_asset_uuid") = "")
        .def_prop_rw("prefab_asset_uuid",
                     &termin::prefab::PrefabInstanceState::prefab_asset_uuid,
                     &termin::prefab::PrefabInstanceState::set_prefab_asset_uuid)
        .def_prop_rw("source_revision",
                     &termin::prefab::PrefabInstanceState::source_revision,
                     &termin::prefab::PrefabInstanceState::set_source_revision)
        .def_prop_ro("entity_mapping_count", &termin::prefab::PrefabInstanceState::entity_mapping_count)
        .def_prop_ro("component_mapping_count", &termin::prefab::PrefabInstanceState::component_mapping_count)
        .def_prop_ro("property_override_count", &termin::prefab::PrefabInstanceState::property_override_count)
        .def_prop_ro("structural_override_count", &termin::prefab::PrefabInstanceState::structural_override_count)
        .def_prop_ro("overrides_valid", &termin::prefab::PrefabInstanceState::overrides_valid)
        .def_prop_ro("structural_overrides_valid", &termin::prefab::PrefabInstanceState::structural_overrides_valid)
        .def_prop_ro("mapping_valid", &termin::prefab::PrefabInstanceState::mapping_valid)
        .def("entity_for_source", &termin::prefab::PrefabInstanceState::entity_for_source, nb::arg("source_id"))
        .def("component_owner_for_source",
             &termin::prefab::PrefabInstanceState::component_owner_for_source,
             nb::arg("source_id"))
        .def("source_for_entity", &termin::prefab::PrefabInstanceState::source_for_entity, nb::arg("runtime_entity"))
        .def("source_for_component",
             &termin::prefab::PrefabInstanceState::source_for_component,
             nb::arg("runtime_owner"),
             nb::arg("runtime_component_source_id"))
        .def(
        ...
        .def(
            ...
            [](const termin::prefab::PrefabInstanceState& self,
               ...
               const std::string& field_path) -> nb::object {
                const auto* found = self.property_override(source_entity_id, source_component_id, field_path);
                if (found == nullptr)
                    return nb::none();
        ...
        .def(
            ...
            [](termin::prefab::PrefabInstanceState& self, const termin::prefab::PrefabDocument& source) {
        ...
        .def(
            ...
            [](termin::prefab::PrefabInstanceState& self, termin::prefab::PrefabStructuralOverride item) {
                std::string error;
        ...
        .def("discard_structural_override",
        ...
        .def(
            ...
            nb::arg("kind"),
            nb::arg("source_id"))
        .def("clear_all_property_overrides",
             &termin::prefab::PrefabInstanceState::clear_all_property_overrides,
             nb::arg("source"))
        .def("discard_property_override",
             &termin::prefab::PrefabInstanceState::discard_property_override,
             nb::arg("source_entity_id"),
             nb::arg("source_component_id"),
             nb::arg("field_path"))
        .def("discard_all_property_overrides", &termin::prefab::PrefabInstanceState::discard_all_property_overrides);
    ...
    m.def(
        ...
        nb::arg("prefab_asset_uuid"));
    m.def("count_live_instances", &termin::prefab::count_live_prefab_instances, nb::arg("prefab_asset_uuid"));
    ...
    nb::class_<termin::prefab::PrefabDocument>(m, "PrefabDocument")
        .def_static(
            ...
            [](const std::string& text) {
                termin::prefab::PrefabDocumentResult result = termin::prefab::PrefabDocument::parse_json(text);
                if (!result.ok()) {
        ...
        .def_static(
            "capture",
            [](const std::string& asset_uuid, const termin::Entity& root) {
                termin::prefab::PrefabDocumentResult result = termin::prefab::PrefabDocument::capture(asset_uuid, root);
                if (!result.ok()) {
                    throw nb::value_error(result.message.c_str());
                }
                return result.document;
        ...
        .def_static(
            "empty",
            [](const std::string& asset_uuid, const std::string& root_source_id, const std::string& root_name) {
                termin::prefab::PrefabDocumentResult result =
                    termin::prefab::PrefabDocument::empty(asset_uuid, root_source_id, root_name);
                if (!result.ok()) {
                    throw nb::value_error(result.message.c_str());
                }
                return result.document;
            ...
            nb::arg("asset_uuid"),
            nb::arg("root_source_id"),
            nb::arg("root_name"))
        .def_prop_ro("version",
                     [](const termin::prefab::PrefabDocument&) {
        ...
        .def(
            "materialize_source",
            [](const termin::prefab::PrefabDocument& document, nb::object scene, nb::object parent) {
                if (scene.is_none()) {
                ...
                termin::prefab::PrefabDocumentResult result = document.materialize_source(scene_handle, parent_entity);
                if (!result.ok()) {
        ...
        [](const termin::prefab::PrefabDocument& document,
           ...
           nb::object position) {
            ...
            termin::prefab::PrefabInstantiateResult result =
                termin::prefab::PrefabInstantiator::instantiate(document, scene_handle, parent_entity, options);
            if (!result.ok()) {
                throw std::runtime_error(result.message);
            }
            return result.root;
    ...
    m.def(
        ...
        [](nb::object data, nb::object scene, nb::object parent, nb::object name, nb::object position) {
            ...
            termin::prefab::PrefabInstantiateResult result =
                termin::prefab::PrefabInstantiator::instantiate(hierarchy, scene_handle, parent_entity, options);
            if (!result.ok()) {
                throw std::runtime_error(result.message);
            }
            return result.root;
