...
namespace {
    ...
    class TestResourceResolver final : public termin::prefab::PrefabOverrideResourceResolver {
    public:
    ...
    PrefabOverrideValue parse_ok(const std::string& value_json) {
        const std::string document =
            R"({"schema":"termin.prefab.override-value","version":1,"value":)" + value_json + "}";
        std::string error;
    ...
    void test_scalar_round_trip_and_materialization() {
        ...
        PrefabOverrideValue integer = parse_ok(R"({"tag":"int64","value":"9223372036854775807"})");
        ...
        PrefabOverrideValue number = parse_ok(R"({"tag":"float64","value":"1.2345678901234567"})");
        ...
        PrefabOverrideValue unsigned_integer = parse_ok(R"({"tag":"uint64","value":"18446744073709551615"})");
    ...
    void test_dense_array_is_not_inferred_from_list() {
        ...
        PrefabOverrideValue numeric_list =
            parse_ok(R"({"tag":"list","items":[{"tag":"float64","value":"1"},{"tag":"float64","value":"2"}]})");
    ...
    void test_kind_and_resource_contracts() {
        ...
        PrefabOverrideValue resource =
            parse_ok(R"({"tag":"resource","resource_type":"mesh","kind":"tc_mesh","uuid":"mesh-uuid","name":"Cube"})");
    ...
    void test_native_inspect_value_factory() {
        ...
        auto nested_encoded = PrefabOverrideValue::from_inspect_value(&nested, "settings", error);
    ...
    void test_malformed_values_are_rejected() {
        const std::string prefix = R"({"schema":"termin.prefab.override-value","version":1,"value":)";
        parse_fails(R"({"schema":"termin.prefab.override-value","version":2,"value":{"tag":"none"}})", "version");
        ...
        parse_fails(
            prefix +
                R"({"tag":"dict","entries":[{"key":"x","value":{"tag":"none"}},{"key":"x","value":{"tag":"none"}}]}})",
            "duplicate");
        parse_fails(prefix +
                        R"({"tag":"array","dtype":"float32","shape":[2,2],"items":[{"tag":"float64","value":"1"}]}})",
                    "shape product");
        parse_fails(prefix +
                        R"({"tag":"array","dtype":"complex64","shape":[1],"items":[{"tag":"float64","value":"1"}]}})",
                    "dtype");
        parse_fails(prefix + R"({"tag":"array","dtype":"int32","shape":[1],"items":[{"tag":"float64","value":"1"}]}})",
                    "incompatible");
        parse_fails(prefix + R"({"tag":"resource","resource_type":"mesh","kind":"tc_mesh","uuid":""}})",
                    "must not be empty");
    }
