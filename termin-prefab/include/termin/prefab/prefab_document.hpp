...
namespace termin::prefab {
    ...
    public:
        ...
        static PrefabDocumentResult capture(const std::string& asset_uuid, const Entity& editable_root);
        static PrefabDocumentResult
        empty(const std::string& asset_uuid, const std::string& root_source_id, const std::string& root_name);

        bool valid() const;
        const std::string& asset_uuid() const {
            return _asset_uuid;
        }
        const nos::trent& source_hierarchy() const {
            return _root;
        }
        ...
        PrefabDocumentResult materialize_source(tc_scene_handle target_scene, const Entity& parent = Entity()) const;
    ...
    struct PrefabDocumentResult {
        ...
        bool ok() const {
            return error == PrefabDocumentError::None;
        }
    };
