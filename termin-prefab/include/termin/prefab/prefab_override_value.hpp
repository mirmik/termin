...
namespace termin::prefab {
    ...
    public:
        ...
        virtual bool resolve(std::string_view resource_type,
    ...
    public:
        ...
        static std::optional<PrefabOverrideValue> parse(const tc_value* encoded, std::string& error);
        static std::optional<PrefabOverrideValue> parse_json(const std::string& json, std::string& error);
        static std::optional<PrefabOverrideValue>
        from_inspect_value(const tc_value* value, std::string_view target_kind, std::string& error);
        ...
        std::optional<tc::trent> materialize_for_inspect(std::string_view target_kind, std::string& error) const;
        std::optional<tc::trent> materialize_for_inspect(std::string_view target_kind,
