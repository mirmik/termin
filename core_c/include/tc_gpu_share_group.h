...
TC_API tc_gpu_share_group* tc_gpu_share_group_get_or_create(uintptr_t key);

// Increment refcount.
TC_API tc_gpu_share_group* tc_gpu_share_group_ref(tc_gpu_share_group* group);

// Decrement refcount. When it reaches 0, delete all GL resources and free.
// Must be called with a valid GL context active.
TC_API void tc_gpu_share_group_unref(tc_gpu_share_group* group);

// ============================================================================
// Slot access (auto-grow arrays if needed)
// ============================================================================

TC_API tc_gpu_slot* tc_gpu_share_group_texture_slot(tc_gpu_share_group* g, uint32_t index);
TC_API tc_gpu_slot* tc_gpu_share_group_shader_slot(tc_gpu_share_group* g, uint32_t index);
TC_API tc_gpu_mesh_data_slot* tc_gpu_share_group_mesh_data_slot(tc_gpu_share_group* g, uint32_t index);
