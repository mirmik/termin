...
TC_API void tc_shader_add_ref(tc_shader* shader);

// Decrement reference count. Returns true if shader was destroyed
TC_API bool tc_shader_release(tc_shader* shader);
...
TC_API void tc_shader_compute_hash(
...
TC_API void tc_shader_update_hash(tc_shader* shader);
