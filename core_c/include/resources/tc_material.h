...
TC_API bool tc_material_phase_set_uniform(
...
TC_API bool tc_material_phase_set_texture(
    tc_material_phase* phase,
    const char* name,
    tc_texture_handle texture
);
...
TC_API bool tc_material_phase_get_color(
    const tc_material_phase* phase,
    float* r, float* g, float* b, float* a
);

// Set color (u_color uniform) on phase
TC_API void tc_material_phase_set_color(
    tc_material_phase* phase,
    float r, float g, float b, float a
);
...
// Find phase by mark
TC_API tc_material_phase* tc_material_find_phase(tc_material* mat, const char* mark);

// Set uniform on all phases
TC_API void tc_material_set_uniform(
    tc_material* mat,
    const char* name,
    tc_uniform_type type,
    const void* value
...
TC_API void tc_material_set_texture(
    tc_material* mat,
    const char* name,
    tc_texture_handle texture
);
...
TC_API bool tc_material_get_color(
    const tc_material* mat,
    float* r, float* g, float* b, float* a
);

// Set color on all phases
TC_API void tc_material_set_color(
    tc_material* mat,
    float r, float g, float b, float a
);
...
TC_API void tc_material_add_ref(tc_material* mat);
TC_API bool tc_material_release(tc_material* mat);
