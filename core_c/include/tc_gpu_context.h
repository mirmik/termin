...
TC_API tc_gpu_context* tc_gpu_context_new(uintptr_t key, tc_gpu_share_group* group);
...
TC_API tc_gpu_vao_slot* tc_gpu_context_vao_slot(tc_gpu_context* ctx, uint32_t index);
