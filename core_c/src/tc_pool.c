...
static bool pool_grow(tc_pool* pool) {
    ...
    if (!new_data) {
        tc_log_error("tc_pool: failed to grow data array");
        return false;
    }
    pool->data = new_data;
    ...
    if (!new_gens) {
        tc_log_error("tc_pool: failed to grow generations array");
        return false;
    }
    ...
    if (!new_states) {
        tc_log_error("tc_pool: failed to grow states array");
        return false;
    }
    ...
    if (!new_free) {
        tc_log_error("tc_pool: failed to grow free list");
        return false;
    }
