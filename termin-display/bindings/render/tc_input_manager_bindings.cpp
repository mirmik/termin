...
namespace termin {
    ...
    static void
    py_on_pointer(tc_input_manager* m, uint64_t pointer_id, int device, int phase, double x, double y, float pressure) {
        if (!m || !m->body || !m->userdata)
            return;
        PyInputManagerVTable* vt = static_cast<PyInputManagerVTable*>(m->userdata);
        if (vt->on_pointer.is_none())
            return;
    ...
    static void py_on_mouse_button(tc_input_manager* m, int button, int action, int mods, uint32_t click_count) {
        if (!m || !m->body || !m->userdata)
            return;
        PyInputManagerVTable* vt = static_cast<PyInputManagerVTable*>(m->userdata);
        if (vt->on_mouse_button.is_none())
            return;
    ...
    void bind_tc_input_manager(nb::module_& m) {
        ...
        m.def(
            ...
            [](nb::object on_mouse_button,
               ...
               nb::object on_key,
               nb::object on_char,
               nb::object on_pointer) -> uintptr_t {
            ...
            nb::arg("on_mouse_button"),
            nb::arg("on_mouse_move"),
            nb::arg("on_scroll"),
            nb::arg("on_key"),
            nb::arg("on_char"),
        ...
        m.def(
            ...
            [](uintptr_t ptr, int button, int action, int mods, uint32_t click_count) {
        ...
        m.def("_input_manager_on_pointer",
              [](uintptr_t ptr, uint64_t pointer_id, int device, int phase, double x, double y, float pressure) {
                  tc_input_manager* m = reinterpret_cast<tc_input_manager*>(ptr);
        ...
        m.def(
            ...
            [](uint32_t index, uint32_t generation) -> uintptr_t {
                return reinterpret_cast<uintptr_t>(tc_display_get_input_manager(tc_display_handle{index, generation}));
            },
            nb::arg("index"),
            nb::arg("generation"),
        ...
        m.def(
            ...
            [](uint32_t vp_index, uint32_t vp_generation) -> uintptr_t {
