...
tc_input_manager* tc_input_manager_new(const tc_input_manager_vtable* vtable, void* body) {
    if (!vtable) {
...
TERMIN_DISPLAY_API void
tc_input_manager_dispatch_key(tc_input_manager* m, int key, int scancode, int action, int mods) {
