...
TERMIN_DISPLAY_API tc_viewport_input_manager* tc_viewport_input_manager_new(tc_viewport_handle viewport);

// Free viewport input manager (clears viewport's input_manager if still set)
TERMIN_DISPLAY_API void tc_viewport_input_manager_free(tc_viewport_input_manager* m);
