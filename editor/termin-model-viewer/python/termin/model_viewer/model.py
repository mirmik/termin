...
_DEFAULT_LIGHT_DIRECTION = (0.0, 0.9781476007338057, 0.20791169081775931)
...
class VisualModel:
    ...
    def __init__(self, scene, items: list, bounds: ModelBounds) -> None:
        self.scene = scene
        self.items = items
        self.bounds = bounds
...
def compose_visual_model(scene_data) -> VisualModel:
    ...
    try:
        ...
        return VisualModel(visual_scene, items, bounds)
    except Exception:
