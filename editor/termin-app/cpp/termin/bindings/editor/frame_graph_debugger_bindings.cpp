...
namespace termin {
    ...
    void bind_frame_graph_debugger(nb::module_& m) {
        ...
        nb::class_<FrameGraphDebuggerView>(m, "FrameGraphDebuggerView")
            ...
            .def("show_resource", &FrameGraphDebuggerView::show_resource, nb::arg("resource"))
            .def("connect_remote",
                 &FrameGraphDebuggerView::connect_remote,
                 nb::arg("port"),
                 nb::arg("authentication_token"))
            .def("disconnect_remote", &FrameGraphDebuggerView::disconnect_remote)
            .def("use_local", &FrameGraphDebuggerView::use_local)
            .def("render_previews", &FrameGraphDebuggerView::render_previews, nb::arg("context"))
            .def("refresh_depth", &FrameGraphDebuggerView::refresh_depth, nb::arg("device"))
            ...
            .def_prop_ro("state_status_text",
                         [](const FrameGraphDebuggerView& self) {
