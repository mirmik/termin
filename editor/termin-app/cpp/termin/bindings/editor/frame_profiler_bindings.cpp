...
namespace termin {
    ...
    void bind_frame_profiler(nb::module_& m) {
        ...
        nb::class_<FrameProfilerController>(m, "FrameProfilerController")
            ...
            .def("set_profiling", &FrameProfilerController::set_profiling, nb::arg("enabled"))
            ...
            .def("select_frame", &FrameProfilerController::select_frame, nb::arg("frame_number"))
            .def("show_section_details", &FrameProfilerController::show_section_details, nb::arg("node"))
            .def("connect_remote",
                 &FrameProfilerController::connect_remote,
                 nb::arg("port"),
