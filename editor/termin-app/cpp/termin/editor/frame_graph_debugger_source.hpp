...
namespace termin {
    ...
    struct FrameGraphDebuggerGapSnapshot {
        FrameGraphDebuggerGapKind kind = FrameGraphDebuggerGapKind::TransportDrop;
    ...
    struct FrameGraphDebuggerCpuCaptureSnapshot {
        ...
        FrameGraphDebuggerPixelFormat pixel_format = FrameGraphDebuggerPixelFormat::Unknown;
        std::uint32_t width = 0;
        std::uint32_t height = 0;
        bool is_depth = false;
        bool exact = false;
    ...
    struct FrameGraphDebuggerSnapshot {
        ...
        FrameGraphDebuggerSourceKind source_kind = FrameGraphDebuggerSourceKind::Local;
        ...
        FrameGraphDebuggerSuspendReason suspend_reason = FrameGraphDebuggerSuspendReason::None;
    ...
    public:
        ...
        virtual bool start_live_preview(std::uint32_t max_millifps, std::uint32_t max_long_edge) {
            (void)max_millifps;
            (void)max_long_edge;
            return false;
        }
        virtual bool stop_live_preview() {
            return false;
        }
        ...
        virtual bool render_image(tgfx::RenderContext2& context,
        ...
        read_depth_normalized(tgfx::IRenderDevice& device, int* width, int* height) = 0;
    };
