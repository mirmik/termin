...
TEST_CASE("parse_shader_text: rejects implicit GLSL texture binding order shader") {
    const std::string shader_text =
        ...
        "@phase opaque\n"
        "@property Texture2D u_input = \"white\" encoding(srgb)\n"
        "@property Texture2D u_depth = \"white\" encoding(linear)\n"
        "@property Texture2D u_normal = \"normal\" encoding(linear)\n"
        "@property Texture2D u_roughness = \"white\" encoding(linear)\n"
        "@property Texture2D u_emissive = \"white\" encoding(srgb)\n"
        "@stage fragment\n"
        "#version 330 core\n"
        "uniform sampler2D u_input;\n"
