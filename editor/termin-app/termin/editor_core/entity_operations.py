...
All create/delete/rename/reparent/duplicate/drop flows live here. The native
scene-tree projection delegates to an EntityOperations instance.
...
class EntityOperations:
    ...
    def drop_glb(
        ...
        glb_asset = rm.get_runtime_asset("glb", glb_name)
