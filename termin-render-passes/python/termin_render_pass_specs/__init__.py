"""Lightweight builtin specs owned by termin-render-passes."""
...
FRAME_PASS_SPECS: list[tuple[str, str]] = [
    ...
    ("termin.render_passes", "OutputTransformPass"),
