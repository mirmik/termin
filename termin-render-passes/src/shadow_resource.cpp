...
namespace termin {
    namespace {
        ...
        FrameGraphResourceSampledTexture shadow_map_array_sampled_texture(const FrameGraphResource& resource) {
            const auto& shadow_array = static_cast<const ShadowMapArrayResource&>(resource);
