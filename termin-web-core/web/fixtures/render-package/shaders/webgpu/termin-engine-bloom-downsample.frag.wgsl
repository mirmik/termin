struct BloomDownsampleParams_std140_0
{
    @align(16) texel_size_0 : vec2<f32>,
};

@binding(7) @group(0) var<uniform> u_params_0 : BloomDownsampleParams_std140_0;
...
{
    var offset_0 : f32 = u_params_0.texel_size_0.x;
    var _S2 : vec2<f32> = _S1.uv_0 + vec2<f32>(-3.23076915740966797f * offset_0, 0.0f);
    ;
    ...
    var _S4 : vec2<f32> = _S1.uv_0 + vec2<f32>(-1.38461542129516602f * offset_0, 0.0f);
    ;
    ...
    var _S6 : vec2<f32> = _S1.uv_0 + vec2<f32>(1.38461542129516602f * offset_0, 0.0f);
    ;
    var result_3 : vec3<f32> = result_2 + (textureSample((u_texture_texture_0), (u_texture_sampler_0), (_S6))).xyz * _S5;
    var _S7 : vec2<f32> = _S1.uv_0 + vec2<f32>(3.23076915740966797f * offset_0, 0.0f);
    ;
