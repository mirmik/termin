...
namespace termin::qopt
{
    ...
    class Articulation3DContribution;
    ...
    class TERMIN_QOPT_API ContactEndpoint3D
    {
      public:
        ContactEndpoint3D() = default;

        [[nodiscard]] static ContactEndpoint3D
        static_world(termin::Vec3 position_world) noexcept;
        [[nodiscard]] static ContactEndpoint3D
        rigid_body(RigidBody3DContribution& body, termin::Vec3 point_local) noexcept;
        [[nodiscard]] static ContactEndpoint3D
    ...
    class TERMIN_QOPT_API ContactSet3DContribution final : public DynamicsContribution
    {
      public:
      ...
      private:
        ...
        [[nodiscard]] bool update_state(std::size_t index,
