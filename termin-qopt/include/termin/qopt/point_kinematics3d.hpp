...
namespace termin::qopt
{
    ...
    struct TERMIN_QOPT_API PointKinematics3D
    {
        ...
        [[nodiscard]] ConstDenseMatrixView linear_jacobian_world() const noexcept;

        // Overwrites generalized_effort with J^T * force_world.
        [[nodiscard]] PointKinematics3DDiagnostic map_force_to_generalized_effort(
            termin::Vec3 force_world,
            DenseVectorView generalized_effort) const noexcept;
    };

    struct TERMIN_QOPT_API PointKinematics3DResult
    {
        PointKinematics3D value;
        PointKinematics3DDiagnostic diagnostic = PointKinematics3DDiagnostic::None;
    ...
    // coordinates.
    [[nodiscard]] TERMIN_QOPT_API PointKinematics3DResult
